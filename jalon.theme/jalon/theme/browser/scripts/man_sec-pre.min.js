...
AmCharts.wrappedText=function(a,b,c,d,e,f,g,h,k){var l=AmCharts.text(a,b,c,d,e,f,g),m="\n";AmCharts.isModern||(m="<br>");if(10<k)return l;if(l){var p=l.getBBox();if(p.width>h){l.remove();for(var l=[],n=0;-1<(index=b.indexOf(" ",n));)l.push(index),n=index+1;for(var t=Math.round(b.length/2),q=1E3,r,n=0;n<l.length;n++){var u=Math.abs(l[n]-t);u<q&&(r=l[n],q=u)}if(isNaN(r)){h=Math.ceil(p.width/h);for(n=1;n<h;n++)r=Math.round(b.length/h*n),b=b.substr(0,r)+m+b.substr(r);return AmCharts.text(a,b,c,d,e,f,
...
1)||0>=this.minimum))this.fire("logarithmicAxisFailed",{type:"logarithmicAxisFailed",chart:a});else{this.grid0=null;var c,d,e=a.dx,f=a.dy,g=!1,h=this.logarithmic;if(isNaN(this.min)||isNaN(this.max)||!this.foundGraphs||Infinity==this.min||-Infinity==this.max)g=!0;else{var k=this.labelFrequency,l=this.showFirstLabel,m=this.showLastLabel,p=1,n=0,t=Math.round((this.max-this.min)/this.step)+1,q;!0===h?(q=Math.log(this.max)*Math.LOG10E-Math.log(this.minReal)*Math.LOG10E,this.stepWidth=this.axisWidth/q,
q>this.logGridLimit&&(t=Math.ceil(Math.log(this.max)*Math.LOG10E)+1,n=Math.round(Math.log(this.minReal)*Math.LOG10E),t>this.gridCountR&&(p=Math.ceil(t/this.gridCountR)))):this.stepWidth=this.axisWidth/(this.max-this.min);var r=0;1>this.step&&-1<this.step&&(r=AmCharts.getDecimals(this.step));this.integersOnly&&(r=0);r>this.maxDecCount&&(r=this.maxDecCount);var u=this.precision;isNaN(u)||(r=u);this.max=AmCharts.roundTo(this.max,this.maxDecCount);this.min=AmCharts.roundTo(this.min,this.maxDecCount);
var v={};v.precision=r;v.decimalSeparator=a.nf.decimalSeparator;v.thousandsSeparator=a.nf.thousandsSeparator;this.numberFormatter=v;var s,w=this.guides,y=w.length;if(0<y){c=this.fillAlpha;for(d=this.fillAlpha=0;d<y;d++){var E=w[d],A=NaN,z=E.above;isNaN(E.toValue)||(A=this.getCoordinate(E.toValue),s=new this.axisItemRenderer(this,A,"",!0,NaN,NaN,E),this.pushAxisItem(s,z));var I=NaN;isNaN(E.value)||(I=this.getCoordinate(E.value),s=new this.axisItemRenderer(this,I,E.label,!0,NaN,(A-I)/2,E),this.pushAxisItem(s,
z));isNaN(A-I)||(s=new this.guideFillRenderer(this,I,A,E),this.pushAxisItem(s,z),s=s.graphics(),E.graphics=s,E.balloonText&&this.addEventListeners(s,E))}this.fillAlpha=c}w=!1;for(d=n;d<t;d+=p)y=AmCharts.roundTo(this.step*d+this.min,r),-1!=String(y).indexOf("e")&&(w=!0,String(y).split("e"));this.duration&&(this.maxInterval=AmCharts.getMaxInterval(this.max,this.duration));var r=this.step,G,y=this.minorGridAlpha;this.minorGridEnabled&&(G=this.getMinorGridStep(r,this.stepWidth*r));for(d=n;d<t;d+=p)if(n=
r*d+this.min,n=AmCharts.roundTo(n,this.maxDecCount+1),!this.integersOnly||Math.round(n)==n)if(isNaN(u)||Number(AmCharts.toFixed(n,u))==n){!0===h&&(0===n&&(n=this.minReal),q>this.logGridLimit&&(n=Math.pow(10,d)),w=-1!=String(n).indexOf("e")?!0:!1);this.useScientificNotation&&(w=!0);this.usePrefixes&&(w=!1);w?(s=-1==String(n).indexOf("e")?n.toExponential(15):String(n),c=s.split("e"),s=Number(c[0]),c=Number(c[1]),s=AmCharts.roundTo(s,14),10==s&&(s=1,c+=1),s=s+"e"+c,0===n&&(s="0"),1==n&&(s="1")):(h&&
(s=String(n).split("."),s[1]?(v.precision=s[1].length,0>d&&(v.precision=Math.abs(d))):v.precision=-1),s=this.usePrefixes?AmCharts.addPrefix(n,a.prefixesOfBigNumbers,a.prefixesOfSmallNumbers,v,!0):AmCharts.formatNumber(n,v,v.precision));this.duration&&(s=AmCharts.formatDuration(n,this.duration,"",this.durationUnits,this.maxInterval,v));this.recalculateToPercents?s+="%":(c=this.unit)&&(s="left"==this.unitPosition?c+s:s+c);Math.round(d/k)!=d/k&&(s=void 0);if(0===d&&!l||d==t-1&&!m)s=" ";c=this.getCoordinate(n);
this.labelFunction&&(s=this.labelFunction(n,s,this).toString());s=new this.axisItemRenderer(this,c,s);this.pushAxisItem(s);if(n==this.baseValue&&"radar"!=a.type){var B,K,z=this.viW,A=this.viH;s=this.viX;E=this.viY;"H"==this.orientation?0<=c&&c<=z+1&&(B=[c,c,c+e],K=[A,0,f]):0<=c&&c<=A+1&&(B=[0,z,z+e],K=[c,c,c+f]);B&&(c=AmCharts.fitToBounds(2*this.gridAlpha,0,1),c=AmCharts.line(a.container,B,K,this.gridColor,c,1,this.dashLength),c.translate(s,E),this.grid0=c,a.axesSet.push(c),c.toBack())}if(!isNaN(G)&&
0<y&&d<t-1){s=this.gridAlpha;this.gridAlpha=this.minorGridAlpha;for(c=1;c<r/G;c++)E=this.getCoordinate(n+G*c),E=new this.axisItemRenderer(this,E,"",!1,0,0,!1,!1,0,!0),this.pushAxisItem(E);this.gridAlpha=s}}d=this.baseValue;this.min>this.baseValue&&this.max>this.baseValue&&(d=this.min);this.min<this.baseValue&&this.max<this.baseValue&&(d=this.max);h&&d<this.minReal&&(d=this.minReal);this.baseCoord=this.getCoordinate(d);d={type:"axisChanged",target:this,chart:a};d.min=h?this.minReal:this.min;d.max=
...
a);b.axesSet.push(d);this.set=d}});AmCharts.RecItem=AmCharts.Class({construct:function(a,b,c,d,e,f,g,h,k,l){b=Math.round(b);this.value=c;void 0==c&&(c="");k||(k=0);void 0==d&&(d=!0);var m=a.chart.fontFamily,p=a.fontSize;void 0==p&&(p=a.chart.fontSize);var n=a.color;void 0==n&&(n=a.chart.color);var t=a.chart.container,q=t.set();this.set=q;var r=a.axisThickness,u=a.axisColor,v=a.axisAlpha,s=a.tickLength,w=a.gridAlpha,y=a.gridThickness,E=a.gridColor,A=a.dashLength,z=a.fillColor,I=a.fillAlpha,G=a.labelsEnabled,B=a.labelRotation,K=a.counter,
M=a.inside,ca=a.dx,W=a.dy,Na=a.orientation,ia=a.position,ma=a.previousCoord,U=a.viH,X=a.viW,$=a.offset,ra,P;g?(G=!0,isNaN(g.tickLength)||(s=g.tickLength),void 0!=g.lineColor&&(E=g.lineColor),void 0!=g.color&&(n=g.color),isNaN(g.lineAlpha)||(w=g.lineAlpha),isNaN(g.dashLength)||(A=g.dashLength),isNaN(g.lineThickness)||(y=g.lineThickness),!0===g.inside&&(M=!0),isNaN(g.labelRotation)||(B=g.labelRotation),isNaN(g.fontSize)||(p=g.fontSize),g.position&&(ia=g.position)):""===c&&(s=0);P="start";e&&(P="middle");
var Y=B*Math.PI/180,pa,H=0,F=0,V=0,da=pa=0,ja=0;"V"==Na&&(B=0);var x;G&&(x=a.autoWrap&&0===B?AmCharts.wrappedText(t,c,n,m,p,P,h,e,0):AmCharts.text(t,c,n,m,p,P,h),P=x.getBBox(),da=P.width,ja=P.height);if("H"==Na){if(0<=b&&b<=X+1&&(0<s&&0<v&&b+k<=X+1&&(ra=AmCharts.line(t,[b+k,b+k],[0,s],u,v,y),q.push(ra)),0<w&&(P=AmCharts.line(t,[b,b+ca,b+ca],[U,U+W,W],E,w,y,A),q.push(P))),F=0,H=b,g&&90==B&&M&&(H-=p),!1===d?(P="start",F="bottom"==ia?M?F+s:F-s:M?F-s:F+s,H+=3,e&&(H+=e/2,P="middle"),0<B&&(P="middle")):
P="middle",1==K&&0<I&&!g&&!l&&ma<X&&(d=AmCharts.fitToBounds(b,0,X),ma=AmCharts.fitToBounds(ma,0,X),pa=d-ma,0<pa&&(fill=AmCharts.rect(t,pa,a.height,z,I),fill.translate(d-pa+ca,W),q.push(fill))),"bottom"==ia?(F+=U+p/2+$,M?0<B?(F=U-da/2*Math.sin(Y)-s-3,H+=da/2*Math.cos(Y)-4+2):0>B?(F=U+da*Math.sin(Y)-s-3+2,H+=-da*Math.cos(Y)-ja*Math.sin(Y)-4):F-=s+p+3+3:0<B?(F=U+da/2*Math.sin(Y)+s+3,H-=da/2*Math.cos(Y)):0>B?(F=U+s+3-da/2*Math.sin(Y)+2,H+=da/2*Math.cos(Y)):F+=s+r+3+3):(F+=W+p/2-$,H+=ca,M?0<B?(F=da/2*
Math.sin(Y)+s+3,H-=da/2*Math.cos(Y)):F+=s+3:0<B?(F=-(da/2)*Math.sin(Y)-s-6,H+=da/2*Math.cos(Y)):F-=s+p+3+r+3),"bottom"==ia?pa=(M?U-s-1:U+r-1)+$:(V=ca,pa=(M?W:W-s-r+1)-$),f&&(H+=f),W=H,0<B&&(W+=da/2*Math.cos(Y)),x&&(ia=0,M&&(ia=da/2*Math.cos(Y)),W+ia>X+2||0>W))x.remove(),x=null}else{0<=b&&b<=U+1&&(0<s&&0<v&&b+k<=U+1&&(ra=AmCharts.line(t,[0,s],[b+k,b+k],u,v,y),q.push(ra)),0<w&&(P=AmCharts.line(t,[0,ca,X+ca],[b,b+W,b+W],E,w,y,A),q.push(P)));P="end";if(!0===M&&"left"==ia||!1===M&&"right"==ia)P="start";
F=b-p/2;1==K&&0<I&&!g&&!l&&(d=AmCharts.fitToBounds(b,0,U),ma=AmCharts.fitToBounds(ma,0,U),Y=d-ma,fill=AmCharts.polygon(t,[0,a.width,a.width,0],[0,0,Y,Y],z,I),fill.translate(ca,d-Y+W),q.push(fill));F+=p/2;"right"==ia?(H+=ca+X+$,F+=W,M?(H-=s+4,f||(F-=p/2+3)):(H+=s+4+r,F-=2)):M?(H+=s+4-$,f||(F-=p/2+3),g&&(H+=ca,F+=W)):(H+=-s-r-4-2-$,F-=2);ra&&("right"==ia?(V+=ca+$+X,pa+=W,V=M?V-r:V+r):(V-=$,M||(V-=s+r)));f&&(F+=f);M=-3;"right"==ia&&(M+=W);x&&(F>U+1||F<M)&&(x.remove(),x=null)}ra&&ra.translate(V,pa);!1===
a.visible&&(ra&&ra.remove(),x&&(x.remove(),x=null));x&&(x.attr({"text-anchor":P}),x.translate(H,F),0!==B&&x.rotate(-B,a.chart.backgroundColor),a.allLabels.push(x)," "!=c&&(this.label=x));l||(a.counter=0===K?1:0,a.previousCoord=b);0===this.set.node.childNodes.length&&this.set.remove()},graphics:function(){return this.set},getLabel:function(){return this.label}});AmCharts.RecFill=AmCharts.Class({construct:function(a,b,c,d){var e=a.dx,f=a.dy,g=a.orientation,h=0;if(c<b){var k=b;b=c;c=k}var l=d.fillAlpha;isNaN(l)&&(l=0);k=a.chart.container;d=d.fillColor;"V"==g?(b=AmCharts.fitToBounds(b,0,a.viH),c=AmCharts.fitToBounds(c,0,a.viH)):(b=AmCharts.fitToBounds(b,0,a.viW),c=AmCharts.fitToBounds(c,0,a.viW));c-=b;isNaN(c)&&(c=4,h=2,l=0);0>c&&"object"==typeof d&&(d=d.join(",").split(",").reverse());"V"==g?(a=AmCharts.rect(k,a.width,c,d,l),a.translate(e,b-h+f)):(a=AmCharts.rect(k,
c,a.height,d,l),a.translate(b-h+e,f));this.set=k.set([a])},graphics:function(){return this.set},getLabel:function(){}});AmCharts.AmChart=AmCharts.Class({construct:function(a){this.theme=a;this.version="3.9.1";AmCharts.addChart(this);this.createEvents("dataUpdated","init","rendered","drawn");this.height=this.width="100%";this.dataChanged=!0;this.chartCreated=!1;this.previousWidth=this.previousHeight=0;this.backgroundColor="#FFFFFF";this.borderAlpha=this.backgroundAlpha=0;this.color=this.borderColor="#000000";this.fontFamily="Verdana";this.fontSize=11;this.usePrefixes=!1;this.precision=-1;this.percentPrecision=2;this.decimalSeparator=
...
this.realHeight)):a=new AmCharts.AmDraw(this.chartDiv,this.realWidth,this.realHeight,this);a.handDrawn=this.handDrawn;a.handDrawScatter=this.handDrawScatter;a.handDrawThickness=this.handDrawThickness;this.container=a;if(AmCharts.VML||AmCharts.SVG)a=this.container,this.set=a.set(),this.gridSet=a.set(),this.cursorLineSet=a.set(),this.graphsBehindSet=a.set(),this.bulletBehindSet=a.set(),this.columnSet=a.set(),this.graphsSet=a.set(),this.trendLinesSet=a.set(),this.axesLabelsSet=a.set(),this.axesSet=a.set(),
this.cursorSet=a.set(),this.scrollbarsSet=a.set(),this.bulletSet=a.set(),this.freeLabelsSet=a.set(),this.balloonsSet=a.set(),this.balloonsSet.setAttr("id","balloons"),this.zoomButtonSet=a.set(),this.linkSet=a.set(),this.renderFix()},measure:function(){var a=this.div;if(a){var b=this.chartDiv,c=a.offsetWidth,d=a.offsetHeight,e=this.container;a.clientHeight&&(c=a.clientWidth,d=a.clientHeight);var f=AmCharts.removePx(AmCharts.getStyle(a,"padding-left")),g=AmCharts.removePx(AmCharts.getStyle(a,"padding-right")),
h=AmCharts.removePx(AmCharts.getStyle(a,"padding-top")),k=AmCharts.removePx(AmCharts.getStyle(a,"padding-bottom"));isNaN(f)||(c-=f);isNaN(g)||(c-=g);isNaN(h)||(d-=h);isNaN(k)||(d-=k);f=a.style;a=f.width;f=f.height;-1!=a.indexOf("px")&&(c=AmCharts.removePx(a));-1!=f.indexOf("px")&&(d=AmCharts.removePx(f));a=AmCharts.toCoordinate(this.width,c);f=AmCharts.toCoordinate(this.height,d);this.balloon=AmCharts.processObject(this.balloon,AmCharts.AmBalloon,this.theme);this.balloon.chart=this;if(a!=this.previousWidth||
f!=this.previousHeight)b.style.width=a+"px",b.style.height=f+"px",e&&e.setSize(a,f);this.balloon.setBounds(2,2,a-2,f);this.realWidth=a;this.realHeight=f;this.divRealWidth=c;this.divRealHeight=d}},destroy:function(){this.chartDiv.innerHTML="";this.clearTimeOuts();this.interval&&clearInterval(this.interval);this.interval=NaN},clearTimeOuts:function(){var a=this.timeOuts;if(a){var b;for(b=0;b<a.length;b++)clearTimeout(a[b])}this.timeOuts=[]},clear:function(a){AmCharts.callMethod("clear",[this.chartScrollbar,
...
this.fillColorsSwitched=this.lineColorSwitched=void 0;var a=this.chart,b=this.id,c=this.index,d=this.data,e=this.chart.container,f=this.valueAxis,g=this.type,h=this.columnWidthReal,k=this.showBulletsAt;isNaN(this.columnWidth)||(h=this.columnWidth);isNaN(h)&&(h=.8);var l=this.width,m=this.height,p=this.y,n=this.rotate,t=this.columnCount,q=AmCharts.toCoordinate(this.cornerRadiusTop,h/2),r=this.connect,u=[],v=[],s,w,y,E,A=this.chart.graphs.length,z,I=this.dx/this.depthCount,G=this.dy/this.depthCount,
B=f.stackType,K=this.labelPosition,M=this.start,ca=this.end,W=this.scrollbar,Na=this.categoryAxis,ia=this.baseCoord,ma=this.negativeBase,U=this.columnIndex,X=this.lineThickness,$=this.lineAlpha,ra=this.lineColorR,P=this.dashLength,Y=this.set,pa=K,H=this.getGradRotation(),F=this.chart.columnSpacing,V=Na.cellWidth,da=(V*h-t)/t;F>da&&(F=da);var ja,x,Wa,eb=m+1,fb=l+1,Xa=0,gb=0,hb,ib,Ya,Za,Ob=this.fillColorsR,Oa=this.negativeFillColors,Da=this.negativeLineColor,Pa=this.fillAlphas,Qa=this.negativeFillAlphas;
"object"==typeof Pa&&(Pa=Pa[0]);"object"==typeof Qa&&(Qa=Qa[0]);var $a=f.getCoordinate(f.min);f.logarithmic&&($a=f.getCoordinate(f.minReal));this.minCoord=$a;this.resetBullet&&(this.bullet="none");if(!W&&("line"==g||"smoothedLine"==g||"step"==g)&&(1==d.length&&"step"!=g&&"none"==this.bullet&&(this.bullet="round",this.resetBullet=!0),Oa||void 0!=Da)){var Ja=ma;Ja>f.max&&(Ja=f.max);Ja<f.min&&(Ja=f.min);f.logarithmic&&(Ja=f.minReal);var Aa=f.getCoordinate(Ja),yb=f.getCoordinate(f.max);n?(eb=m,fb=Math.abs(yb-
Aa),hb=m,ib=Math.abs($a-Aa),Za=gb=0,f.reversed?(Xa=0,Ya=Aa):(Xa=Aa,Ya=0)):(fb=l,eb=Math.abs(yb-Aa),ib=l,hb=Math.abs($a-Aa),Ya=Xa=0,f.reversed?(Za=p,gb=Aa):Za=Aa+1)}var Ba=Math.round;this.pmx=Ba(Xa);this.pmy=Ba(gb);this.pmh=Ba(eb);this.pmw=Ba(fb);this.nmx=Ba(Ya);this.nmy=Ba(Za);this.nmh=Ba(hb);this.nmw=Ba(ib);AmCharts.isModern||(this.nmy=this.nmx=0,this.nmh=this.height);h="column"==g?(V*h-F*(t-1))/t:V*h;1>h&&(h=1);var J;if("line"==g||"step"==g||"smoothedLine"==g){if(0<M){for(J=M-1;-1<J;J--)if(ja=d[J],
x=ja.axes[f.id].graphs[b],Wa=x.values.value,!isNaN(Wa)){M=J;break}if(this.lineColorField)for(J=M;-1<J;J--)if(ja=d[J],x=ja.axes[f.id].graphs[b],x.lineColor){this.bulletColorSwitched=this.lineColorSwitched=x.lineColor;break}if(this.fillColorsField)for(J=M;-1<J;J--)if(ja=d[J],x=ja.axes[f.id].graphs[b],x.fillColors){this.fillColorsSwitched=x.fillColors;break}if(this.dashLengthField)for(J=M;-1<J;J--)if(ja=d[J],x=ja.axes[f.id].graphs[b],!isNaN(x.dashLength)){this.dashLengthSwitched=x.dashLength;break}}if(ca<
d.length-1)for(J=ca+1;J<d.length;J++)if(ja=d[J],x=ja.axes[f.id].graphs[b],Wa=x.values.value,!isNaN(Wa)){ca=J;break}}ca<d.length-1&&ca++;var Q=[],R=[],Ea=!1;if("line"==g||"step"==g||"smoothedLine"==g)if(this.stackable&&"regular"==B||"100%"==B||this.fillToGraph)Ea=!0;var zb=this.noStepRisers,ab=-1E3,bb=-1E3,cb=this.minDistance;for(J=M;J<=ca;J++){ja=d[J];x=ja.axes[f.id].graphs[b];x.index=J;var S,T,O,aa,ka=NaN,D=NaN,C=NaN,N=NaN,L=NaN,Fa=NaN,va=NaN,Ga=NaN,wa=NaN,ba=NaN,ha=NaN,ea=NaN,fa=NaN,Z=NaN,jb=NaN,
kb=NaN,na=NaN,qa=void 0,Ca=Ob,Ra=Pa,sa=ra,oa,ta,Sa=this.pattern;void 0!=x.pattern&&(Sa=x.pattern);void 0!=x.color&&(Ca=x.color);x.fillColors&&(Ca=x.fillColors);isNaN(x.alpha)||(Ra=x.alpha);isNaN(x.dashLength)||(P=x.dashLength);var ua=x.values;f.recalculateToPercents&&(ua=x.percents);if(ua){Z=this.stackable&&"none"!=B&&"3d"!=B?ua.close:ua.value;if("candlestick"==g||"ohlc"==g)Z=ua.close,kb=ua.low,va=f.getCoordinate(kb),jb=ua.high,wa=f.getCoordinate(jb);na=ua.open;C=f.getCoordinate(Z);isNaN(na)||(L=
f.getCoordinate(na));if(!W)switch(this.showBalloonAt){case "close":x.y=C;break;case "open":x.y=L;break;case "high":x.y=wa;break;case "low":x.y=va}var ka=ja.x[Na.id],Ka=this.periodSpan-1,la=Math.floor(V/2)+Math.floor(Ka*V/2),xa=la,Ab=0;"left"==this.stepDirection&&(Ab=(2*V+Ka*V)/2,ka-=Ab);"start"==this.pointPosition&&(ka-=V/2+Math.floor(Ka*V/2),la=0,xa=Math.floor(V)+Math.floor(Ka*V));"end"==this.pointPosition&&(ka+=V/2+Math.floor(Ka*V/2),la=Math.floor(V)+Math.floor(Ka*V),xa=0);if(zb){var lb=this.columnWidth;
isNaN(lb)||(la*=lb,xa*=lb)}W||(x.x=ka);-1E5>ka&&(ka=-1E5);ka>l+1E5&&(ka=l+1E5);n?(D=C,N=L,L=C=ka,isNaN(na)&&!this.fillToGraph&&(N=ia),Fa=va,Ga=wa):(N=D=ka,isNaN(na)&&!this.fillToGraph&&(L=ia));Z<na&&(x.isNegative=!0,Oa&&(Ca=Oa),Qa&&(Ra=Qa),void 0!=Da&&(sa=Da));switch(g){case "line":if(isNaN(Z))r||(this.drawLineGraph(u,v,Q,R),u=[],v=[],Q=[],R=[]);else{x.isNegative=Z<ma?!0:!1;if(Math.abs(D-ab)>=cb||Math.abs(C-bb)>=cb)u.push(D),v.push(C),ab=D,bb=C;ba=D;ha=C;ea=D;fa=C;!Ea||isNaN(L)||isNaN(N)||(Q.push(N),
...
cb)u.push(D),v.push(C),ab=D,bb=C;ba=D;ha=C;ea=D;fa=C;!Ea||isNaN(L)||isNaN(N)||(Q.push(N),R.push(L));void 0==x.lineColor&&void 0==x.fillColors&&isNaN(x.dashLength)||(this.drawSmoothedGraph(u,v,Q,R),u=[D],v=[C],Q=[],R=[],!Ea||isNaN(L)||isNaN(N)||(Q.push(N),R.push(L)),this.lineColorSwitched=x.lineColor,this.fillColorsSwitched=x.fillColors,this.dashLengthSwitched=x.dashLength);x.gap&&(this.drawSmoothedGraph(u,v,Q,R),u=[],v=[],Q=[],R=[])}break;case "step":if(!isNaN(Z)){if(x.isNegative=Z<ma?!0:!1,void 0==
x.lineColor&&void 0==x.fillColors&&isNaN(x.dashLength)||(this.drawLineGraph(u,v,Q,R),u=[],v=[],Q=[],R=[],this.lineColorSwitched=x.lineColor,this.fillColorsSwitched=x.fillColors,this.dashLengthSwitched=x.dashLength),n?(isNaN(s)||(u.push(s),v.push(C-la)),v.push(C-la),u.push(D),v.push(C+xa),u.push(D),!Ea||isNaN(L)||isNaN(N)||(Q.push(y),R.push(L-la),Q.push(N),R.push(L-la),Q.push(N),R.push(L+xa))):(isNaN(w)||(v.push(w),u.push(s),v.push(w),u.push(D-la)),u.push(D-la),v.push(C),u.push(D+xa),v.push(C),!Ea||
isNaN(L)||isNaN(N)||(Q.push(N-la),R.push(E),Q.push(N-la),R.push(L),Q.push(N+xa),R.push(L))),s=D,w=C,y=N,E=L,ba=D,ha=C,ea=D,fa=C,zb||x.gap)s=w=NaN,this.drawLineGraph(u,v,Q,R),u=[],v=[],Q=[],R=[]}else if(!r){if(1>=this.periodSpan||1<this.periodSpan&&D-s>la+xa)s=w=NaN;this.drawLineGraph(u,v,Q,R);u=[];v=[];Q=[];R=[]}break;case "column":oa=sa;void 0!=x.lineColor&&(oa=x.lineColor);if(!isNaN(Z)){Z<ma?(x.isNegative=!0,Oa&&(Ca=Oa),void 0!=Da&&(oa=Da)):x.isNegative=!1;var Bb=f.min,Cb=f.max;if(!(Z<Bb&&na<Bb||
Z>Cb&&na>Cb))if(n){"3d"==B?(T=C-.5*(h+F)+F/2+G*U,S=N+I*U):(T=Math.floor(C-(t/2-U)*(h+F)+F/2),S=N);O=h;ba=D;ha=T+h/2;ea=D;fa=T+h/2;T+O>m&&(O=m-T);0>T&&(O+=T,T=0);aa=D-N;var Pb=S;S=AmCharts.fitToBounds(S,0,l);aa+=Pb-S;aa=AmCharts.fitToBounds(aa,-S,l-S+I*U);if(T<m&&0<O&&(qa=new AmCharts.Cuboid(e,aa,O,I-a.d3x,G-a.d3y,Ca,Ra,X,oa,$,H,q,n,P,Sa),"bottom"!=K&&"inside"!=K&&"middle"!=K))if(K=f.reversed?"left":"right",0>Z)K=f.reversed?"right":"left";else if("regular"==B||"100%"==B)ba+=this.dx}else{"3d"==B?(S=
D-.5*(h+F)+F/2+I*U,T=L+G*U):(S=D-(t/2-U)*(h+F)+F/2,T=L);O=h;ba=S+h/2;ha=C;ea=S+h/2;fa=C;S+O>l+U*I&&(O=l-S+U*I);0>S&&(O+=S,S=0);aa=C-L;var Qb=T;T=AmCharts.fitToBounds(T,this.dy,m);aa+=Qb-T;aa=AmCharts.fitToBounds(aa,-T+G*U,m-T);if(S<l+U*I&&0<O)if(qa=new AmCharts.Cuboid(e,O,aa,I-a.d3x,G-a.d3y,Ca,Ra,X,oa,this.lineAlpha,H,q,n,P,Sa),0>Z&&"middle"!=K&&"inside"!=K)K="bottom";else if(K=pa,"regular"==B||"100%"==B)ha+=this.dy}if(qa&&(ta=qa.set,ta.translate(S,T),this.columnsSet.push(ta),(x.url||this.showHandOnHover)&&
ta.setAttr("cursor","pointer"),!W)){"none"==B&&(z=n?(this.end+1-J)*A-c:A*J+c);"3d"==B&&(n?(z=(A-c)*(this.end+1-J),ba+=I*this.columnIndex,ea+=I*this.columnIndex,x.y+=I*this.columnIndex):(z=(A-c)*(J+1),ba+=3,ha+=G*this.columnIndex+7,fa+=G*this.columnIndex,x.y+=G*this.columnIndex));if("regular"==B||"100%"==B)"inside"!=K&&(K="middle"),z=n?0<ua.value?(this.end+1-J)*A+c:(this.end+1-J)*A-c:0<ua.value?A*J+c:A*J-c;this.columnsArray.push({column:qa,depth:z});x.x=n?T+O/2:S+O/2;this.ownColumns.push(qa);this.animateColumns(qa,
J,D,N,C,L);this.addListeners(ta,x)}}break;case "candlestick":if(!isNaN(na)&&!isNaN(Z)){var db,mb;oa=sa;void 0!=x.lineColor&&(oa=x.lineColor);if(n){if(T=C-h/2,S=N,O=h,T+O>m&&(O=m-T),0>T&&(O+=T,T=0),T<m&&0<O){var nb,ob;Z>na?(nb=[D,Ga],ob=[N,Fa]):(nb=[N,Ga],ob=[D,Fa]);!isNaN(Ga)&&!isNaN(Fa)&&C<m&&0<C&&(db=AmCharts.line(e,nb,[C,C],oa,$,X),mb=AmCharts.line(e,ob,[C,C],oa,$,X));aa=D-N;qa=new AmCharts.Cuboid(e,aa,O,I,G,Ca,Pa,X,oa,$,H,q,n,P,Sa)}}else if(S=D-h/2,T=L+X/2,O=h,S+O>l&&(O=l-S),0>S&&(O+=S,S=0),aa=
C-L,S<l&&0<O){var qa=new AmCharts.Cuboid(e,O,aa,I,G,Ca,Ra,X,oa,$,H,q,n,P,Sa),pb,qb;Z>na?(pb=[C,wa],qb=[L,va]):(pb=[L,wa],qb=[C,va]);!isNaN(wa)&&!isNaN(va)&&D<l&&0<D&&(db=AmCharts.line(e,[D,D],pb,oa,$,X),mb=AmCharts.line(e,[D,D],qb,oa,$,X))}qa&&(ta=qa.set,Y.push(ta),ta.translate(S,T-X/2),(x.url||this.showHandOnHover)&&ta.setAttr("cursor","pointer"),db&&(Y.push(db),Y.push(mb)),ba=D,ha=C,n?(fa=C,ea=D,"open"==k&&(ea=N),"high"==k&&(ea=Ga),"low"==k&&(ea=Fa)):(fa=C,"open"==k&&(fa=L),"high"==k&&(fa=wa),"low"==
k&&(fa=va),ea=D),W||(x.x=n?T+O/2:S+O/2,this.animateColumns(qa,J,D,N,C,L),this.addListeners(ta,x)))}break;case "ohlc":if(!(isNaN(na)||isNaN(jb)||isNaN(kb)||isNaN(Z))){Z<na&&(x.isNegative=!0,void 0!=Da&&(sa=Da));var rb,sb,tb;if(n){var ub=C-h/2,ub=AmCharts.fitToBounds(ub,0,m),Db=AmCharts.fitToBounds(C,0,m),vb=C+h/2,vb=AmCharts.fitToBounds(vb,0,m);sb=AmCharts.line(e,[N,N],[ub,Db],sa,$,X,P);0<C&&C<m&&(rb=AmCharts.line(e,[Fa,Ga],[C,C],sa,$,X,P));tb=AmCharts.line(e,[D,D],[Db,vb],sa,$,X,P);fa=C;ea=D;"open"==
k&&(ea=N);"high"==k&&(ea=Ga);"low"==k&&(ea=Fa)}else{var wb=D-h/2,wb=AmCharts.fitToBounds(wb,0,l),Eb=AmCharts.fitToBounds(D,0,l),xb=D+h/2,xb=AmCharts.fitToBounds(xb,0,l);sb=AmCharts.line(e,[wb,Eb],[L,L],sa,$,X,P);0<D&&D<l&&(rb=AmCharts.line(e,[D,D],[va,wa],sa,$,X,P));tb=AmCharts.line(e,[Eb,xb],[C,C],sa,$,X,P);fa=C;"open"==k&&(fa=L);"high"==k&&(fa=wa);"low"==k&&(fa=va);ea=D}Y.push(sb);Y.push(rb);Y.push(tb);ba=D;ha=C}}if(!W&&!isNaN(Z)){var Fb=this.hideBulletsCount;if(this.end-this.start<=Fb||0===Fb){var Ha=
this.createBullet(x,ea,fa,J);Ha||(Ha=0);var Gb=this.labelText;if(Gb){var ga=this.createLabel(x,0,0,Gb),ya=0,za=0,Hb=ga.getBBox(),La=Hb.width,Ia=Hb.height;switch(K){case "left":ya=-(La/2+Ha/2+3);break;case "top":za=-(Ia/2+Ha/2+3);break;case "right":ya=Ha/2+2+La/2;break;case "bottom":n&&"column"==g?(ba=ia,0>Z||0<Z&&f.reversed?(ya=-6,ga.attr({"text-anchor":"end"})):(ya=6,ga.attr({"text-anchor":"start"}))):(za=Ha/2+Ia/2,ga.x=-(La/2+2));break;case "middle":"column"==g&&(n?(za=-(Ia/2)+this.fontSize/2,ya=
-(D-N)/2-I,0>aa&&(ya+=I),Math.abs(D-N)<La&&!this.showAllValueLabels&&(ga.remove(),ga=null)):(za=-(C-L)/2,0>aa&&(za-=G),Math.abs(C-L)<Ia&&!this.showAllValueLabels&&(ga.remove(),ga=null)));break;case "inside":n?(za=-(Ia/2)+this.fontSize/2,ya=0>aa?La/2+6:-La/2-6):za=0>aa?Ia:-Ia}if(ga){if(isNaN(ha)||isNaN(ba))ga.remove(),ga=null;else if(ba+=ya,ha+=za,ga.translate(ba,ha),n){if(0>ha||ha>m)ga.remove(),ga=null}else{var Ib=0;"3d"==B&&(Ib=I*U);if(0>ba||ba>l+Ib)ga.remove(),ga=null}ga&&this.allBullets.push(ga)}}if("regular"==
B||"100%"==B){var Jb=f.totalText;if(Jb){var Ma=this.createLabel(x,0,0,Jb,f.totalTextColor);this.allBullets.push(Ma);var Kb=Ma.getBBox(),Lb=Kb.width,Mb=Kb.height,Ta,Ua,Nb=f.totals[J];Nb&&Nb.remove();var Va=0;"column"!=g&&(Va=Ha);n?(Ua=C,Ta=0>Z?D-Lb/2-2-Va:D+Lb/2+3+Va):(Ta=D,Ua=0>Z?C+Mb/2+Va:C-Mb/2-3-Va);Ma.translate(Ta,Ua);f.totals[J]=Ma;n?(0>Ua||Ua>m)&&Ma.remove():(0>Ta||Ta>l)&&Ma.remove()}}}}}}if("line"==g||"step"==g||"smoothedLine"==g)"smoothedLine"==g?this.drawSmoothedGraph(u,v,Q,R):this.drawLineGraph(u,
v,Q,R),W||this.launchAnimation();this.bulletsHidden&&this.hideBullets()},animateColumns:function(a,b,c,d,e,f){var g=this;c=g.chart.startDuration;0<c&&!g.animationPlayed&&(g.seqAn?(a.set.hide(),g.animationArray.push(a),a=setTimeout(function(){g.animate.call(g)},c/(g.end-g.start+1)*(b-g.start)*1E3),g.timeOuts.push(a)):g.animate(a))},createLabel:function(a,b,c,d,e){var f=this.chart,g=a.labelColor;g||(g=this.color);g||(g=f.color);e&&(g=e);e=this.fontSize;void 0===e&&(this.fontSize=e=f.fontSize);a=f.formatString(d,
a);a=AmCharts.cleanFromEmpty(a);f=AmCharts.text(this.container,a,g,f.fontFamily,e);f.translate(b,c);this.bulletSet.push(f);return f},positiveClip:function(a){a.clipRect(this.pmx,this.pmy,this.pmw,this.pmh)},negativeClip:function(a){a.clipRect(this.nmx,this.nmy,this.nmw,this.nmh)},drawLineGraph:function(a,b,c,d){var e=this;if(1<a.length){var f=e.set,g=e.container,h=g.set(),k=g.set();f.push(k);f.push(h);var l=e.lineAlpha,m=e.lineThickness,f=e.fillAlphas,p=e.lineColorR,n=e.negativeLineAlpha;isNaN(n)&&
(n=l);var t=e.lineColorSwitched;t&&(p=t);var t=e.fillColorsR,q=e.fillColorsSwitched;q&&(t=q);var r=e.dashLength;(q=e.dashLengthSwitched)&&(r=q);var q=e.negativeLineColor,u=e.negativeFillColors,v=e.negativeFillAlphas,s=e.baseCoord;0!==e.negativeBase&&(s=e.valueAxis.getCoordinate(e.negativeBase));l=AmCharts.line(g,a,b,p,l,m,r,!1,!0);h.push(l);h.click(function(a){e.handleGraphEvent(a,"clickGraph")}).mouseover(function(a){e.handleGraphEvent(a,"rollOverGraph")}).mouseout(function(a){e.handleGraphEvent(a,
"rollOutGraph")});void 0!==q&&(m=AmCharts.line(g,a,b,q,n,m,r,!1,!0),k.push(m));if(0<f||0<v)if(m=a.join(";").split(";"),n=b.join(";").split(";"),"serial"==e.chart.type&&(0<c.length?(c.reverse(),d.reverse(),m=a.concat(c),n=b.concat(d)):e.rotate?(n.push(n[n.length-1]),m.push(s),n.push(n[0]),m.push(s),n.push(n[0]),m.push(m[0])):(m.push(m[m.length-1]),n.push(s),m.push(m[0]),n.push(s),m.push(a[0]),n.push(n[0]))),a=e.gradientRotation,0<f&&(b=AmCharts.polygon(g,m,n,t,f,1,"#000",0,a),b.pattern(e.pattern),
h.push(b)),u||void 0!==q)isNaN(v)&&(v=f),u||(u=q),g=AmCharts.polygon(g,m,n,u,v,1,"#000",0,a),g.pattern(e.pattern),k.push(g),k.click(function(a){e.handleGraphEvent(a,"clickGraph")}).mouseover(function(a){e.handleGraphEvent(a,"rollOverGraph")}).mouseout(function(a){e.handleGraphEvent(a,"rollOutGraph")});e.applyMask(k,h)}},applyMask:function(a,b){var c=a.length();"serial"!=this.chart.type||this.scrollbar||(this.positiveClip(b),0<c&&this.negativeClip(a))},drawSmoothedGraph:function(a,b,c,d){if(1<a.length){var e=
this.set,f=this.container,g=f.set(),h=f.set();e.push(h);e.push(g);var k=this.lineAlpha,l=this.lineThickness,e=this.dashLength,m=this.fillAlphas,p=this.lineColorR,n=this.fillColorsR,t=this.negativeLineColor,q=this.negativeFillColors,r=this.negativeFillAlphas,u=this.baseCoord,v=this.lineColorSwitched;v&&(p=v);(v=this.fillColorsSwitched)&&(n=v);v=this.negativeLineAlpha;isNaN(v)&&(v=k);k=new AmCharts.Bezier(f,a,b,p,k,l,n,0,e);g.push(k.path);void 0!==t&&(l=new AmCharts.Bezier(f,a,b,t,v,l,n,0,e),h.push(l.path));
0<m&&(k=a.join(";").split(";"),p=b.join(";").split(";"),l="",0<c.length?(c.push("M"),d.push("M"),c.reverse(),d.reverse(),k=a.concat(c),p=b.concat(d)):(this.rotate?(l+=" L"+u+","+b[b.length-1],l+=" L"+u+","+b[0]):(l+=" L"+a[a.length-1]+","+u,l+=" L"+a[0]+","+u),l+=" L"+a[0]+","+b[0]),c=new AmCharts.Bezier(f,k,p,NaN,0,0,n,m,e,l),c.path.pattern(this.pattern),g.push(c.path),q||void 0!==t)&&(r||(r=m),q||(q=t),a=new AmCharts.Bezier(f,a,b,NaN,0,0,q,r,e,l),a.path.pattern(this.pattern),h.push(a.path));this.applyMask(h,
g)}},launchAnimation:function(){var a=this,b=a.chart.startDuration;if(0<b&&!a.animationPlayed){var c=a.set,d=a.bulletSet;AmCharts.VML||(c.attr({opacity:a.startAlpha}),d.attr({opacity:a.startAlpha}));c.hide();d.hide();a.seqAn?(b=setTimeout(function(){a.animateGraphs.call(a)},a.index*b*1E3),a.timeOuts.push(b)):a.animateGraphs()}},animateGraphs:function(){var a=this.chart,b=this.set,c=this.bulletSet,d=this.x,e=this.y;b.show();c.show();var f=a.startDuration,a=a.startEffect;b&&(this.rotate?(b.translate(-1E3,
...
(f=a.values.error,isNaN(f)||(g=f),f=this.bulletAxis.stepWidth*g);f<this.minBulletSize&&(f=this.minBulletSize);this.rotate?b=a.isNegative?b-e:b+e:c=a.isNegative?c+e:c-e;var p,m=this.bulletColorR;a.lineColor&&(this.bulletColorSwitched=a.lineColor);this.bulletColorSwitched&&(m=this.bulletColorSwitched);a.isNegative&&void 0!==this.bulletColorNegative&&(m=this.bulletColorNegative);void 0!==a.color&&(m=a.color);var n;"xy"==this.chart.type&&this.valueField&&(n=this.pattern,a.pattern&&(n=a.pattern));e=this.bullet;
a.bullet&&(e=a.bullet);var g=this.bulletBorderThickness,k=this.bulletBorderColorR,l=this.bulletBorderAlpha,t=this.bulletAlpha;k||(k=m);this.useLineColorForBulletBorder&&(k=this.lineColorR);var q=a.alpha;isNaN(q)||(t=q);if("none"!=this.bullet||a.bullet)p=AmCharts.bullet(d,e,f,m,t,g,k,l,h,0,n);if(this.customBullet||a.customBullet)n=this.customBullet,a.customBullet&&(n=a.customBullet),n&&(p&&p.remove(),"function"==typeof n?(p=new n,p.chart=this.chart,a.bulletConfig&&(p.availableSpace=c,p.graph=this,
a.bulletConfig.minCoord=this.minCoord-c,p.bulletConfig=a.bulletConfig),p.write(d),p=p.set):(this.chart.path&&(n=this.chart.path+n),p=d.set(),d=d.image(n,0,0,f,f),p.push(d),this.centerCustomBullets&&d.translate(-f/2,-f/2)));p&&((a.url||this.showHandOnHover)&&p.setAttr("cursor","pointer"),"serial"==this.chart.type&&(0>b-0||b-0>this.width||c<-f/2||c-0>this.height)&&(p.remove(),p=null),p&&(this.bulletSet.push(p),p.translate(b,c),this.addListeners(p,a),this.allBullets.push(p)),a.bx=b,a.by=c);a.bulletGraphics=
p;return f},showBullets:function(){var a=this.allBullets,b;this.bulletsHidden=!1;for(b=0;b<a.length;b++)a[b].show()},hideBullets:function(){var a=this.allBullets,b;this.bulletsHidden=!0;for(b=0;b<a.length;b++)a[b].hide()},addListeners:function(a,b){var c=this;a.mouseover(function(a){c.handleRollOver(b,a)}).mouseout(function(a){c.handleRollOut(b,a)}).touchend(function(a){c.handleRollOver(b,a);c.chart.panEventsEnabled&&c.handleClick(b,a)}).touchstart(function(a){c.handleRollOver(b,a)}).click(function(a){c.handleClick(b,
a)}).dblclick(function(a){c.handleDoubleClick(b,a)}).contextmenu(function(a){c.handleRightClick(b,a)})},handleRollOver:function(a,b){if(a){var c=this.chart,d={type:"rollOverGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("rollOverGraphItem",d);c.fire("rollOverGraphItem",d);clearTimeout(c.hoverInt);d=this.showBalloon;c.chartCursor&&"serial"==c.type&&(d=!1,!c.chartCursor.valueBalloonsEnabled&&this.showBalloon&&(d=!0));if(d){var d=c.formatString(this.balloonText,
a,!0),e=this.balloonFunction;e&&(d=e(a,a.graph));d=AmCharts.cleanFromEmpty(d);e=c.getBalloonColor(this,a);c.balloon.showBullet=!1;c.balloon.pointerOrientation="V";var f=a.x,g=a.y;c.rotate&&(f=a.y,g=a.x);c.showBalloon(d,e,!0,f+c.marginLeftReal,g+c.marginTopReal)}}this.handleGraphEvent(b,"rollOverGraph")},handleRollOut:function(a,b){this.chart.hideBalloon();if(a){var c={type:"rollOutGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("rollOutGraphItem",c);this.chart.fire("rollOutGraphItem",
c)}this.handleGraphEvent(b,"rollOutGraph")},handleClick:function(a,b){if(a){var c={type:"clickGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("clickGraphItem",c);this.chart.fire("clickGraphItem",c);AmCharts.getURL(a.url,this.urlTarget)}this.handleGraphEvent(b,"clickGraph")},handleGraphEvent:function(a,b){var c={type:b,graph:this,target:this,chart:this.chart,event:a};this.fire(b,c);this.chart.fire(b,c)},handleRightClick:function(a,b){if(a){var c={type:"rightClickGraphItem",
...
"middle";this.bulletsEnabled=this.skipZoomDispatch=!1;this.bulletSize=8;this.selectWithoutZooming=this.oneBalloonOnly=!1;this.graphBulletSize=1.7;this.animationDuration=.3;this.zooming=!1;this.adjustment=0;AmCharts.applyTheme(this,a,this.cname)},draw:function(){var a=this;a.destroy();var b=a.chart,c=b.container;a.rotate=b.rotate;a.container=c;c=c.set();c.translate(a.x,a.y);a.set=c;b.cursorSet.push(c);c=new AmCharts.AmBalloon;c.chart=b;a.categoryBalloon=c;AmCharts.copyProperties(b.balloon,c);c.cornerRadius=
...
a.interval=setInterval(function(){a.detectMovement.call(a)},40)},updateData:function(){var a=this.chart;this.data=a.chartData;this.firstTime=a.firstTime;this.lastTime=a.lastTime},createCursor:function(){var a=this.chart,b=this.cursorAlpha,c=a.categoryAxis,d=c.position,e=c.inside,f=c.axisThickness,g=this.categoryBalloon,h,k,l=a.dx,m=a.dy,p=this.x,n=this.y,t=this.width,q=this.height,a=a.rotate,r=c.tickLength;g.pointerWidth=r;a?(h=[0,t,t+l],k=[0,0,m]):(h=[l,0,0],k=[m,0,q]);this.line=b=AmCharts.line(this.container,
h,k,this.cursorColor,b,1);(h=this.fullRectSet)?(h.push(b),h.translate(this.x,this.y)):this.set.push(b);a?(e&&(g.pointerWidth=0),"right"==d?e?g.setBounds(p,n+m,p+t+l,n+q+m):g.setBounds(p+t+l+f,n+m,p+t+1E3,n+q+m):e?g.setBounds(p,n,t+p,q+n):g.setBounds(-1E3,-1E3,p-r-f,n+q+15)):(g.maxWidth=t,c.parseDates&&(r=0,g.pointerWidth=0),"top"==d?e?g.setBounds(p+l,n+m,t+l+p,q+n):g.setBounds(p+l,-1E3,t+l+p,n+m-r-f):e?g.setBounds(p,n,t+p,q+n-r):g.setBounds(p,n+q+r+f-1,p+t,n+q+r+f));this.hideCursor()},createCrosshair:function(){var a=
...
this.drawingNow&&(AmCharts.remove(this.drawingLine),this.drawingLine=AmCharts.line(this.container,[this.x+this.drawStartX,this.x+e],[this.y+this.drawStartY,this.y+f],this.cursorColor,1,1));if(this.enabled){void 0===b&&(b=!0);this.index=a+=this.adjustment;var g=c.categoryAxis,h=c.dx,k=c.dy,l=this.x+1,m=this.y+1,p=this.width,n=this.height,t=this.data[a];this.fireMoved();if(t){var q=t.x[g.id],r=c.rotate,u=g.inside,v=this.stepWidth,s=this.categoryBalloon,w=this.firstTime,y=this.lastTime,E=this.cursorPosition,
A=g.position,z=this.zooming,I=this.panning,G=c.graphs,B=g.axisThickness;if(c.mouseIsOver||z||I||this.forceShow)if(this.forceShow=!1,I){var h=this.panClickPos,c=this.panClickEndTime,z=this.panClickStartTime,K=this.panClickEnd,l=this.panClickStart,e=(r?h-f:h-e)/v;if(!g.parseDates||g.equalSpacing)e=Math.round(e);0!==e&&(h={type:"zoomed",target:this},h.chart=this.chart,g.parseDates&&!g.equalSpacing?(c+e>y&&(e=y-c),z+e<w&&(e=w-z),h.start=Math.round(z+e),h.end=Math.round(c+e),this.fire(h.type,h)):K+e>=
this.data.length||0>l+e||(h.start=l+e,h.end=K+e,this.fire(h.type,h)))}else{"start"==E?q-=g.cellWidth/2:"mouse"==E&&(c.mouseIsOver?q=r?f-2:e-2:isNaN(this.tempPosition)||(q=this.tempPosition-2));if(r){if(0>q)if(z)q=0;else{this.hideCursor();return}if(q>n+1)if(z)q=n+1;else{this.hideCursor();return}}else{if(0>q)if(z)q=0;else{this.hideCursor();return}if(q>p)if(z)q=p;else{this.hideCursor();return}}if(0<this.cursorAlpha){var M=this.line;r?(w=0,y=q+k,d&&(y-=g.cellWidth/2)):(w=q,y=0,d&&(w-=g.cellWidth/2));
v=this.animationDuration;0<v&&!this.zooming?isNaN(this.previousX)?M.translate(w,y):(M.translate(this.previousX,this.previousY),M.animate({translate:w+","+y},v,"easeOutSine")):M.translate(w,y);this.previousX=w;this.previousY=y;M.show()}this.linePos=r?q+k:q;z&&(d&&M.hide(),r?this.updateSelectionSize(NaN,q):this.updateSelectionSize(q,NaN));v=!0;z&&(v=!1);this.categoryBalloonEnabled&&v?(r?(u&&("right"==A?s.setBounds(l,m+k,l+p+h,m+q+k):s.setBounds(l,m+k,l+p+h,m+q)),"right"==A?u?s.setPosition(l+p+h,m+q+
k):s.setPosition(l+p+h+B,m+q+k):u?s.setPosition(l,m+q):s.setPosition(l-B,m+q)):"top"==A?u?s.setPosition(l+q+h,m+k):s.setPosition(l+q+h,m+k-B+1):u?s.setPosition(l+q,m+n):s.setPosition(l+q,m+n+B-1),(w=this.categoryBalloonFunction)?s.showBalloon(w(t.category)):g.parseDates?(g=AmCharts.formatDate(t.category,this.categoryBalloonDateFormat),-1!=g.indexOf("fff")&&(g=AmCharts.formatMilliseconds(g,t.category)),s.showBalloon(g)):s.showBalloon(AmCharts.fixNewLines(t.category))):s.hide();G&&this.bulletsEnabled&&
this.showBullets();if(this.oneBalloonOnly){k=Infinity;for(g=0;g<G.length;g++)w=G[g],w.showBalloon&&!w.hidden&&w.balloonText&&(y=t.axes[w.valueAxis.id].graphs[w.id],s=y.y,isNaN(s)||(r?Math.abs(e-s)<k&&(k=Math.abs(e-s),K=w):Math.abs(f-s)<k&&(k=Math.abs(f-s),K=w)));this.mostCloseGraph&&(K=this.mostCloseGraph)}if(a!=this.previousIndex||K!=this.previousMostCloseGraph)if(this.normalizeBulletSize(),this.destroyValueBalloons(),this.resizedBullets=[],G&&this.valueBalloonsEnabled&&v&&c.balloon.enabled){this.valueBalloons=
v=[];for(g=0;g<G.length;g++)if(w=G[g],s=NaN,(!this.oneBalloonOnly||w==K)&&w.showBalloon&&!w.hidden&&w.balloonText&&("step"==w.type&&"left"==w.stepDirection&&(t=this.data[a+1]),t)){if(y=t.axes[w.valueAxis.id].graphs[w.id])s=y.y;if(this.showNextAvailable&&isNaN(s)&&a+1<this.data.length)for(k=a+1;k<this.data.length;k++)if(q=this.data[k])if(y=q.axes[w.valueAxis.id].graphs[w.id],s=y.y,!isNaN(s))break;if(!isNaN(s)){q=y.x;u=!0;if(r){if(k=s,0>q||q>n)u=!1}else if(k=q,q=s,0>k||k>p+h+1)u=!1;u&&(1!=this.graphBulletSize&&
AmCharts.isModern&&(u=y.bulletGraphics)&&(u.getBBox(),u.translate(y.bx,y.by,this.graphBulletSize),this.resizedBullets.push(y)),u=w.valueBalloon,A=c.getBalloonColor(w,y),u.setBounds(l,m,l+p,m+n),u.pointerOrientation="H",B=this.balloonPointerOrientation,"vertical"==B&&(u.pointerOrientation="V"),"horizontal"==B&&(u.pointerOrientation="H"),u.changeColor(A),void 0!==w.balloonAlpha&&(u.fillAlpha=w.balloonAlpha),void 0!==w.balloonTextColor&&(u.color=w.balloonTextColor),u.setPosition(k+l,q+m),k=c.formatString(w.balloonText,
y,!0),(q=w.balloonFunction)&&(k=q(y,w).toString()),""!==k&&(r?u.showBalloon(k):(u.text=k,u.show=!0),v.push({yy:s,balloon:u})),!r&&u.set&&(u.set.hide(),w=u.textDiv)&&(w.style.visibility="hidden"))}}r||this.arrangeBalloons()}b?(h={type:"changed"},h.index=a,h.chart=this.chart,h.zooming=z,h.mostCloseGraph=K,h.position=r?f:e,h.target=this,c.fire("changed",h),this.fire("changed",h),this.skipZoomDispatch=!1):(this.skipZoomDispatch=!0,c.updateLegendValues(a));this.previousIndex=a;this.previousMostCloseGraph=
K}}}else this.hideCursor()},enableDrawing:function(a){this.enabled=!a;this.hideCursor();this.rolledOver=!1;this.drawing=a},isZooming:function(a){a&&a!=this.zooming&&this.handleMouseDown("fake");a||a==this.zooming||this.handleMouseUp()},handleMouseOut:function(){if(this.enabled)if(this.zooming)this.setPosition();else{this.index=void 0;var a={type:"changed",index:void 0,target:this};a.chart=this.chart;this.fire("changed",a);this.hideCursor()}},handleReleaseOutside:function(){this.handleMouseUp()},handleMouseUp:function(){var a=
this.chart,b=this.data,c;if(a){var d=a.mouseX-this.x,e=a.mouseY-this.y;if(this.drawingNow){this.drawingNow=!1;AmCharts.remove(this.drawingLine);c=this.drawStartX;var f=this.drawStartY;if(2<Math.abs(c-d)||2<Math.abs(f-e))c={type:"draw",target:this,chart:a,initialX:c,initialY:f,finalX:d,finalY:e},this.fire(c.type,c)}if(this.enabled&&0<b.length){if(this.pan)this.rolledOver=!1;else if(this.zoomable&&this.zooming){c=this.selectWithoutZooming?{type:"selected"}:{type:"zoomed"};c.target=this;c.chart=a;if("cursor"==
this.type)this.rotate?this.selectionPosY=e:this.selectionPosX=e=d,2>Math.abs(e-this.initialMouse)&&this.fromIndex==this.index||(this.index<this.fromIndex?(c.end=this.fromIndex,c.start=this.index):(c.end=this.index,c.start=this.fromIndex),e=a.categoryAxis,e.parseDates&&!e.equalSpacing&&(c.start=b[c.start].time,c.end=a.getEndTime(b[c.end].time)),this.skipZoomDispatch||this.fire(c.type,c));else{var g=this.initialMouseX,h=this.initialMouseY;3>Math.abs(d-g)&&3>Math.abs(e-h)||(b=Math.min(g,d),f=Math.min(h,
e),d=Math.abs(g-d),e=Math.abs(h-e),a.hideXScrollbar&&(b=0,d=this.width),a.hideYScrollbar&&(f=0,e=this.height),c.selectionHeight=e,c.selectionWidth=d,c.selectionY=f,c.selectionX=b,this.skipZoomDispatch||this.fire(c.type,c))}this.selectWithoutZooming||AmCharts.remove(this.selection)}this.panning=this.zooming=this.skipZoomDispatch=!1}}},showCursorAt:function(a){var b=this.chart.categoryAxis;a=b.parseDates?b.dateToCoordinate(a):b.categoryToCoordinate(a);this.previousMousePosition=NaN;this.forceShow=!0;
this.setPosition(a,!1)},handleMouseDown:function(a){if(this.zoomable||this.pan||this.drawing){var b=this.rotate,c=this.chart,d=c.mouseX-this.x,e=c.mouseY-this.y;if(0<d&&d<this.width&&0<e&&e<this.height||"fake"==a)this.setPosition(),this.selectWithoutZooming&&AmCharts.remove(this.selection),this.drawing?(this.drawStartY=e,this.drawStartX=d,this.drawingNow=!0):this.pan?(this.zoomable=!1,c.setMouseCursor("move"),this.panning=!0,this.panClickPos=b?e:d,this.panClickStart=this.start,this.panClickEnd=this.end,
this.panClickStartTime=this.startTime,this.panClickEndTime=this.endTime):this.zoomable&&("cursor"==this.type?(this.fromIndex=this.index,b?(this.initialMouse=e,this.selectionPosY=this.linePos):(this.initialMouse=d,this.selectionPosX=this.linePos)):(this.initialMouseX=d,this.initialMouseY=e,this.selectionPosX=d,this.selectionPosY=e),this.zooming=!0)}}});AmCharts.SimpleChartScrollbar=AmCharts.Class({construct:function(a){this.createEvents("zoomed");this.backgroundColor="#D4D4D4";this.backgroundAlpha=1;this.selectedBackgroundColor="#EFEFEF";this.scrollDuration=this.selectedBackgroundAlpha=1;this.resizeEnabled=!0;this.hideResizeGrips=!1;this.scrollbarHeight=20;this.updateOnReleaseOnly=!1;9>document.documentMode&&(this.updateOnReleaseOnly=!0);this.dragIconWidth=18;this.dragIconHeight=25;AmCharts.applyTheme(this,a,"SimpleChartScrollbar")},draw:function(){var a=
...
0;p.axisAlpha=0;m.push(p.set);e?(p.y=g,p.x=0):(p.x=f,p.y=0);var f=Infinity,g=-Infinity,t;for(t=0;t<c.length;t++){var q=c[t].axes[n.id].graphs[l.id].values,r;for(r in q)if(q.hasOwnProperty(r)&&"percents"!=r&&"total"!=r){var u=q[r];u<f&&(f=u);u>g&&(g=u)}}Infinity!=f&&(p.minimum=f);-Infinity!=g&&(p.maximum=g+.1*(g-f));f==g&&(p.minimum-=1,p.maximum+=1);void 0!==a.minimum&&(p.minimum=a.minimum);void 0!==a.maximum&&(p.maximum=a.maximum);p.zoom(0,c.length-1);r=a.unselectedGraph;r.id=l.id;r.rotate=e;r.chart=
...
c.balloonsSet.push(f);if(this.show){var g=this.l,h=this.t,k=this.r,l=this.b,m=this.balloonColor,p=this.fillColor,n=this.borderColor,t=p;void 0!=m&&(this.adjustBorderColor?t=n=m:p=m);var q=this.horizontalPadding,r=this.verticalPadding,u=this.pointerWidth,v=this.pointerOrientation,s=this.cornerRadius,w=c.fontFamily,y=this.fontSize;void 0==y&&(y=c.fontSize);var m=document.createElement("div"),E=m.style;E.position="absolute";var A=this.minWidth,z="";isNaN(A)||(z="min-width:"+(A-2*q)+"px; ");m.innerHTML=
'<div style="text-align:'+this.textAlign+"; "+z+"max-width:"+this.maxWidth+"px; font-size:"+y+"px; color:"+this.color+"; font-family:"+w+'">'+this.text+"</div>";c.chartDiv.appendChild(m);this.textDiv=m;y=m.offsetWidth;w=m.offsetHeight;m.clientHeight&&(y=m.clientWidth,w=m.clientHeight);w+=2*r;z=y+2*q;!isNaN(A)&&z<A&&(z=A);window.opera&&(w+=2);var I=!1,y=this.offsetY;c.handDrawn&&(y+=c.handDrawScatter+2);"H"!=v?(A=a-z/2,b<h+w+10&&"down"!=v?(I=!0,d&&(b+=y),y=b+u,this.deltaSignY=-1):(d&&(b-=y),y=b-w-
u,this.deltaSignY=1)):(2*u>w&&(u=w/2),y=b-w/2,a<g+(k-g)/2?(A=a+u,this.deltaSignX=-1):(A=a-z-u,this.deltaSignX=1));y+w>=l&&(y=l-w);y<h&&(y=h);A<g&&(A=g);A+z>k&&(A=k-z);var h=y+r,l=A+q,r=this.shadowAlpha,G=this.shadowColor,q=this.borderThickness,B=this.bulletSize,K;0<s||0===u?(0<r&&(a=AmCharts.rect(e,z,w,p,0,q+1,G,r,this.cornerRadius),AmCharts.isModern?a.translate(1,1):a.translate(4,4),f.push(a)),p=AmCharts.rect(e,z,w,p,this.fillAlpha,q,n,this.borderAlpha,this.cornerRadius),this.showBullet&&(K=AmCharts.circle(e,
B,t,this.fillAlpha),f.push(K))):(t=[],s=[],"H"!=v?(g=a-A,g>z-u&&(g=z-u),g<u&&(g=u),t=[0,g-u,a-A,g+u,z,z,0,0],s=I?[0,0,b-y,0,0,w,w,0]:[w,w,b-y,w,w,0,0,w]):(t=b-y,t>w-u&&(t=w-u),t<u&&(t=u),s=[0,t-u,b-y,t+u,w,w,0,0],t=a<g+(k-g)/2?[0,0,A<a?0:a-A,0,0,z,z,0]:[z,z,A+z>a?z:a-A,z,z,0,0,z]),0<r&&(a=AmCharts.polygon(e,t,s,p,0,q,G,r),a.translate(1,1),f.push(a)),p=AmCharts.polygon(e,t,s,p,this.fillAlpha,q,n,this.borderAlpha));this.bg=p;f.push(p);p.toFront();e=1*this.deltaSignX;E.left=l+"px";E.top=h+"px";f.translate(A-
e,y);p=p.getBBox();this.bottom=y+w+1;this.yPos=p.y+y;K&&K.translate(this.pointToX-A+e,b-y);b=this.animationDuration;0<this.animationDuration&&!d&&!isNaN(this.prevX)&&(f.translate(this.prevX,this.prevY),f.animate({translate:A-e+","+y},b,"easeOutSine"),m&&(E.left=this.prevTX+"px",E.top=this.prevTY+"px",this.xAnim=c.animate({node:m},"left",this.prevTX,l,b,"easeOutSine","px"),this.yAnim=c.animate({node:m},"top",this.prevTY,h,b,"easeOutSine","px")));this.prevX=A-e;this.prevY=y;this.prevTX=l;this.prevTY=
...
m=b.count,n=AmCharts.getPeriodDuration(l,m));var t={};this.lookupTable=t;var q,r=this.dataDateFormat,u={};for(q=0;q<e.length;q++){var v={},s=e[q];b=s[this.categoryField];v.dataContext=s;v.category=g?g(b,s,h):String(b);k&&(v.forceShow=s[k]);t[s[d]]=v;if(f&&(b=h.categoryFunction?h.categoryFunction(b,s,h):b instanceof Date?AmCharts.newDate(b,h.minPeriod):r?AmCharts.stringToDate(b,r):new Date(b),b=AmCharts.resetDateToMin(b,l,m,h.firstDayOfWeek),v.category=b,v.time=b.getTime(),isNaN(v.time)))continue;
var w=this.valueAxes;v.axes={};v.x={};var y;for(y=0;y<w.length;y++){var E=w[y].id;v.axes[E]={};v.axes[E].graphs={};var A;for(A=0;A<a.length;A++){b=a[A];var z=b.id,I=b.periodValue;if(b.valueAxis.id==E){v.axes[E].graphs[z]={};var G={};G.index=q;var B=s;b.dataProvider&&(B=c);G.values=this.processValues(B,b,I);!b.connect&&u&&u[z]&&v.time-p[z]>1.1*n&&(u[z].gap=!0);this.processFields(b,G,B);G.category=v.category;G.serialDataItem=v;G.graph=b;v.axes[E].graphs[z]=G}p[z]=v.time;u[z]=G}}this.chartData[q]=v}}for(c=
0;c<a.length;c++)b=a[c],b.dataProvider&&this.parseGraphData(b)},processValues:function(a,b,c){var d={},e,f=!1;"candlestick"!=b.type&&"ohlc"!=b.type||""===c||(f=!0);e=Number(a[b.valueField+c]);isNaN(e)||(d.value=e);e=Number(a[b.errorField+c]);isNaN(e)||(d.error=e);f&&(c="Open");e=Number(a[b.openField+c]);isNaN(e)||(d.open=e);f&&(c="Close");e=Number(a[b.closeField+c]);isNaN(e)||(d.close=e);f&&(c="Low");e=Number(a[b.lowField+c]);isNaN(e)||(d.low=e);f&&(c="High");e=Number(a[b.highField+c]);isNaN(e)||
(d.high=e);return d},parseGraphData:function(a){var b=a.dataProvider,c=a.seriesIdField;c||(c=this.seriesIdField);c||(c=this.categoryField);var d;for(d=0;d<b.length;d++){var e=b[d],f=this.lookupTable[String(e[c])],g=a.valueAxis.id;f&&(g=f.axes[g].graphs[a.id],g.serialDataItem=f,g.values=this.processValues(e,a,a.periodValue),this.processFields(a,g,e))}},addValueAxis:function(a){a.chart=this;this.valueAxes.push(a);this.validateData()},removeValueAxesAndGraphs:function(){var a=this.valueAxes,b;for(b=
...
isNaN(d.value)||this.valueAxes[0].addGuide(d)}},processGraphs:function(){var a=this.graphs,b;for(b=0;b<a.length;b++){var c=a[b],c=AmCharts.processObject(c,AmCharts.AmGraph,this.theme);a[b]=c;this.chooseGraphColor(c,b);c.chart=this;AmCharts.isString(c.valueAxis)&&(c.valueAxis=this.getValueAxisById(c.valueAxis));c.valueAxis||(c.valueAxis=this.valueAxes[0]);c.id||(c.id="graphAuto"+b+"_"+(new Date).getTime())}},formatString:function(a,b,c){var d=b.graph,e=d.valueAxis;e.duration&&b.values.value&&(e=AmCharts.formatDuration(b.values.value,
e.duration,"",e.durationUnits,e.maxInterval,e.numberFormatter),a=a.split("[[value]]").join(e));a=AmCharts.massReplace(a,{"[[title]]":d.title,"[[description]]":b.description});a=c?AmCharts.fixNewLines(a):AmCharts.fixBrakes(a);return a=AmCharts.cleanFromEmpty(a)},getBalloonColor:function(a,b,c){var d=a.lineColor,e=a.balloonColor;c&&(e=d);c=a.fillColorsR;"object"==typeof c?d=c[0]:void 0!==c&&(d=c);b.isNegative&&(c=a.negativeLineColor,a=a.negativeFillColors,"object"==typeof a?c=a[0]:void 0!==a&&(c=a),
void 0!==c&&(d=c));void 0!==b.color&&(d=b.color);void 0===e&&(e=d);return e},getGraphById:function(a){return AmCharts.getObjById(this.graphs,a)},getValueAxisById:function(a){return AmCharts.getObjById(this.valueAxes,a)},processFields:function(a,b,c){if(a.itemColors){var d=a.itemColors,e=b.index;b.color=e<d.length?d[e]:AmCharts.randomColor()}d="lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern".split(" ");for(e=0;e<d.length;e++){var f=
d[e],g=a[f+"Field"];g&&(g=c[g],AmCharts.isDefined(g)&&(b[f]=g))}b.dataContext=c},chooseGraphColor:function(a,b){if(a.lineColor)a.lineColorR=a.lineColor;else{var c;c=this.colors.length>b?this.colors[b]:AmCharts.randomColor();a.lineColorR=c}a.fillColorsR=a.fillColors?a.fillColors:a.lineColorR;a.bulletBorderColorR=a.bulletBorderColor?a.bulletBorderColor:a.useLineColorForBulletBorder?a.lineColorR:a.bulletColor;a.bulletColorR=a.bulletColor?a.bulletColor:a.lineColorR;if(c=this.patterns)a.pattern=c[b]},
...
this.graphs,c,d=.2;this.legend&&(d=this.legend.rollOverGraphAlpha);if(1!=d)for(c=0;c<b.length;c++){var e=b[c];e!=a&&e.changeOpacity(d)}},unhighlightGraph:function(){var a;this.legend&&(a=this.legend.rollOverGraphAlpha);if(1!=a){a=this.graphs;var b;for(b=0;b<a.length;b++)a[b].changeOpacity(1)}},showGraph:function(a){a.hidden=!1;this.dataChanged=!0;"xy"!=this.type&&(this.marginsUpdated=!1);this.chartCreated&&this.initChart()},hideGraph:function(a){this.dataChanged=!0;"xy"!=this.type&&(this.marginsUpdated=
...
hideSlice:function(a){isNaN(a)?a.hidden=!0:this.chartData[a].hidden=!0;this.hideBalloon();this.invalidateVisibility()},rollOverSlice:function(a,b,c){isNaN(a)||(a=this.chartData[a]);clearTimeout(this.hoverInt);if(!a.hidden){this.pullOnHover&&this.pullSlice(a,1);1>this.hoverAlpha&&a.wedge&&a.wedge.attr({opacity:this.hoverAlpha});var d=a.balloonX,e=a.balloonY;a.pulled&&(d+=a.pullX,e+=a.pullY);var f=this.formatString(this.balloonText,a,!0),g=AmCharts.adjustLuminosity(a.color,-.15);this.showBalloon(f,
...
(c=l);var l=a.zoomOutButton,p;l&&(l.fontSize&&(d=l.fontSize),l.color&&(c=l.color),l.backgroundColor&&(h=l.backgroundColor),isNaN(l.backgroundAlpha)||(a.zoomOutButtonRollOverAlpha=l.backgroundAlpha));var n=l=0;void 0!==a.pathToImages&&f&&(p=a.container.image(a.pathToImages+f,0,0,e,e),b.push(p),p=p.getBBox(),l=p.width+5);void 0!==g&&(c=AmCharts.text(a.container,g,c,a.fontFamily,d,"start"),d=c.getBBox(),n=p?p.height/2-3:d.height/2,c.translate(l,n),b.push(c));p=b.getBBox();c=1;AmCharts.isModern||(c=0);
h=AmCharts.rect(a.container,p.width+2*m+5,p.height+2*m-2,h,1,1,h,c);h.setAttr("opacity",k);h.translate(-m,-m);b.push(h);h.toBack();a.zbBG=h;p=h.getBBox();b.translate(a.marginLeftReal+a.plotAreaWidth-p.width+m,a.marginTopReal+m);b.hide();b.mouseover(function(){a.rollOverZB()}).mouseout(function(){a.rollOutZB()}).click(function(){a.clickZB()}).touchstart(function(){a.rollOverZB()}).touchend(function(){a.rollOutZB();a.clickZB()});for(k=0;k<b.length;k++)b[k].attr({cursor:"pointer"});a.zbSet=b},rollOverZB:function(){this.zbBG.setAttr("opacity",
...
s=n.recalculateToPercents,w=b.dataDateFormat;h&&(k&&(k instanceof Date||(k=w?AmCharts.stringToDate(k,w):new Date(k)),a.initialDate=k,d=h.dateToCoordinate(k)),l&&(d=h.categoryToCoordinate(l)),m&&(m instanceof Date||(m=w?AmCharts.stringToDate(m,w):new Date(m)),a.finalDate=m,e=h.dateToCoordinate(m)),p&&(e=h.categoryToCoordinate(p)));t&&!s&&(isNaN(q)||(d=t.getCoordinate(q)),isNaN(r)||(e=t.getCoordinate(r)));n&&!s&&(isNaN(u)||(f=n.getCoordinate(u)),isNaN(v)||(g=n.getCoordinate(v)));isNaN(d)||isNaN(e)||
isNaN(f)||isNaN(f)||(b.rotate?(h=[f,g],e=[d,e]):(h=[d,e],e=[f,g]),f=a.lineColor,d=AmCharts.line(c,h,e,f,a.lineAlpha,a.lineThickness,a.dashLength),g=h,k=e,p=h[1]-h[0],n=e[1]-e[0],0===p&&(p=.01),0===n&&(n=.01),l=p/Math.abs(p),m=n/Math.abs(n),n=p*n/Math.abs(p*n)*Math.sqrt(Math.pow(p,2)+Math.pow(n,2)),p=Math.asin(p/n),n=90*Math.PI/180-p,p=Math.abs(5*Math.cos(n)),n=Math.abs(5*Math.sin(n)),g.push(h[1]-l*n,h[0]-l*n),k.push(e[1]+m*p,e[0]+m*p),h=AmCharts.polygon(c,g,k,f,.005,0),c=c.set([h,d]),c.translate(b.marginLeftReal,
...
AmCharts.rect=function(a,b,c,d,e,f,g,h,k,l,m){isNaN(f)&&(f=0);void 0===k&&(k=0);void 0===l&&(l=270);isNaN(e)&&(e=0);var p=d,n=!1;"object"==typeof p&&(p=p[0],n=!0);void 0===g&&(g=p);void 0===h&&(h=e);b=Math.round(b);c=Math.round(c);var t=0,q=0;0>b&&(b=Math.abs(b),t=-b);0>c&&(c=Math.abs(c),q=-c);t+=AmCharts.dx;q+=AmCharts.dy;e={fill:p,stroke:g,"fill-opacity":e,"stroke-opacity":h};void 0!==m&&0<m&&(e["stroke-dasharray"]=m);a=a.rect(t,q,b,c,k,f).attr(e);n&&a.gradient("linearGradient",d,l);return a};
...
AmCharts.makeHD=function(a,b,c){for(var d=[],e=[],f=1;f<a.length;f++)for(var g=Number(a[f-1]),h=Number(b[f-1]),k=Number(a[f]),l=Number(b[f]),m=Math.sqrt(Math.pow(k-g,2)+Math.pow(l-h,2)),m=Math.round(m/50)+1,k=(k-g)/m,l=(l-h)/m,p=0;p<=m;p++){var n=g+p*k+Math.random()*c,t=h+p*l+Math.random()*c;d.push(n);e.push(t)}return[d,e]};
AmCharts.handDrawnLine=function(a,b,c,d,e,f,g,h,k,l,m){var p=a.set();for(m=1;m<b.length;m++)for(var n=[b[m-1],b[m]],t=[c[m-1],c[m]],t=AmCharts.makeHD(n,t,a.handDrawScatter),n=t[0],t=t[1],q=1;q<n.length;q++)p.push(AmCharts.line(a,[n[q-1],n[q]],[t[q-1],t[q]],d,e,f+Math.random()*a.handDrawThickness-a.handDrawThickness/2,g,h,k,l,!0));return p};AmCharts.doNothing=function(a){return a};
AmCharts.wedge=function(a,b,c,d,e,f,g,h,k,l,m,p){var n=Math.round;f=n(f);g=n(g);h=n(h);var t=n(g/f*h),q=AmCharts.VML,r=359.5+f/100;359.94<r&&(r=359.94);e>=r&&(e=r);var u=1/180*Math.PI,r=b+Math.sin(d*u)*h,v=c-Math.cos(d*u)*t,s=b+Math.sin(d*u)*f,w=c-Math.cos(d*u)*g,y=b+Math.sin((d+e)*u)*f,E=c-Math.cos((d+e)*u)*g,A=b+Math.sin((d+e)*u)*h,u=c-Math.cos((d+e)*u)*t,z={fill:AmCharts.adjustLuminosity(l.fill,-.2),"stroke-opacity":0,"fill-opacity":l["fill-opacity"]},I=0;180<Math.abs(e)&&(I=1);d=a.set();var G;
q&&(r=n(10*r),s=n(10*s),y=n(10*y),A=n(10*A),v=n(10*v),w=n(10*w),E=n(10*E),u=n(10*u),b=n(10*b),k=n(10*k),c=n(10*c),f*=10,g*=10,h*=10,t*=10,1>Math.abs(e)&&1>=Math.abs(y-s)&&1>=Math.abs(E-w)&&(G=!0));e="";var B;p&&(z["fill-opacity"]=0,z["stroke-opacity"]=l["stroke-opacity"]/2,z.stroke=l.stroke);0<k&&(q?(B=" M"+r+","+(v+k)+" L"+s+","+(w+k),G||(B+=" A"+(b-f)+","+(k+c-g)+","+(b+f)+","+(k+c+g)+","+s+","+(w+k)+","+y+","+(E+k)),B+=" L"+A+","+(u+k),0<h&&(G||(B+=" B"+(b-h)+","+(k+c-t)+","+(b+h)+","+(k+c+t)+
","+A+","+(k+u)+","+r+","+(k+v)))):(B=" M"+r+","+(v+k)+" L"+s+","+(w+k)+(" A"+f+","+g+",0,"+I+",1,"+y+","+(E+k)+" L"+A+","+(u+k)),0<h&&(B+=" A"+h+","+t+",0,"+I+",0,"+r+","+(v+k))),B+=" Z",B=a.path(B,void 0,void 0,"1000,1000").attr(z),d.push(B),B=a.path(" M"+r+","+v+" L"+r+","+(v+k)+" L"+s+","+(w+k)+" L"+s+","+w+" L"+r+","+v+" Z",void 0,void 0,"1000,1000").attr(z),k=a.path(" M"+y+","+E+" L"+y+","+(E+k)+" L"+A+","+(u+k)+" L"+A+","+u+" L"+y+","+E+" Z",void 0,void 0,"1000,1000").attr(z),d.push(B),d.push(k));
q?(G||(e=" A"+n(b-f)+","+n(c-g)+","+n(b+f)+","+n(c+g)+","+n(s)+","+n(w)+","+n(y)+","+n(E)),f=" M"+n(r)+","+n(v)+" L"+n(s)+","+n(w)+e+" L"+n(A)+","+n(u)):f=" M"+r+","+v+" L"+s+","+w+(" A"+f+","+g+",0,"+I+",1,"+y+","+E)+" L"+A+","+u;0<h&&(q?G||(f+=" B"+(b-h)+","+(c-t)+","+(b+h)+","+(c+t)+","+A+","+u+","+r+","+v):f+=" A"+h+","+t+",0,"+I+",0,"+r+","+v);a.handDrawn&&(b=AmCharts.line(a,[r,s],[v,w],l.stroke,l.thickness*Math.random()*a.handDrawThickness,l["stroke-opacity"]),d.push(b));a=a.path(f+" Z",void 0,
...
a.width+15,this.titleHeight=a.height+6;this.index=this.maxLabelWidth=0;if(this.showEntries){for(a=0;a<g.length;a++)this.createEntry(g[a]);for(a=this.index=0;a<g.length;a++)this.createValue(g[a])}this.arrangeEntries();this.updateValues()},arrangeEntries:function(){var a=this.position,b=this.marginLeft+this.titleWidth,c=this.marginRight,d=this.marginTop,e=this.marginBottom,f=this.horizontalGap,g=this.div,h=this.divWidth,k=this.maxColumns,l=this.verticalGap,m=this.spacing,p=h-c-b,n=0,t=0,q=this.container,
r=q.set();this.set=r;q=q.set();r.push(q);var u=this.entries,v,s;for(s=0;s<u.length;s++){v=u[s].getBBox();var w=v.width;w>n&&(n=w);v=v.height;v>t&&(t=v)}var y=w=0,E=f;for(s=0;s<u.length;s++){var A=u[s];this.reversedOrder&&(A=u[u.length-s-1]);v=A.getBBox();var z;this.equalWidths?z=f+y*(n+m+this.markerLabelGap):(z=E,E=E+v.width+f+m);z+v.width>p&&0<s&&0!==y&&(w++,y=0,z=f,E=z+v.width+f+m);A.translate(z,(t+l)*w);y++;!isNaN(k)&&y>=k&&(y=0,w++);q.push(A)}v=q.getBBox();k=v.height+2*l-1;"left"==a||"right"==
a?(h=v.width+2*f,g.style.width=h+b+c+"px"):h=h-b-c-1;c=AmCharts.polygon(this.container,[0,h,h,0],[0,0,k,k],this.backgroundColor,this.backgroundAlpha,1,this.borderColor,this.borderAlpha);r.push(c);r.translate(b,d);c.toBack();b=f;if("top"==a||"bottom"==a||"absolute"==a||"outside"==a)"center"==this.align?b=f+(h-v.width)/2:"right"==this.align&&(b=f+h-v.width);q.translate(b,l+1);this.titleHeight>k&&(k=this.titleHeight);a=k+d+e+1;0>a&&(a=0);g.style.height=Math.round(a)+"px"},createEntry:function(a){if(!1!==
a.visibleInLegend){var b=this.chart,c=a.markerType;c||(c=this.markerType);var d=a.color,e=a.alpha;a.legendKeyColor&&(d=a.legendKeyColor());a.legendKeyAlpha&&(e=a.legendKeyAlpha());var f;!0===a.hidden&&(f=d=this.markerDisabledColor);var g=a.pattern,h=a.customMarker;h||(h=this.customMarker);var k=this.container,l=this.markerSize,m=0,p=0,n=l/2;if(this.useGraphSettings)if(m=a.type,this.switchType=void 0,"line"==m||"step"==m||"smoothedLine"==m||"ohlc"==m)g=k.set(),a.hidden||(d=a.lineColorR,f=a.bulletBorderColorR),
p=AmCharts.line(k,[0,2*l],[l/2,l/2],d,a.lineAlpha,a.lineThickness,a.dashLength),g.push(p),a.bullet&&(a.hidden||(d=a.bulletColorR),p=AmCharts.bullet(k,a.bullet,a.bulletSize,d,a.bulletAlpha,a.bulletBorderThickness,f,a.bulletBorderAlpha))&&(p.translate(l+1,l/2),g.push(p)),n=0,m=l,p=l/3;else{var t;a.getGradRotation&&(t=a.getGradRotation());m=a.fillColorsR;!0===a.hidden&&(m=d);if(g=this.createMarker("rectangle",m,a.fillAlphas,a.lineThickness,d,a.lineAlpha,t,g))n=l,g.translate(n,l/2);m=l}else h?(b.path&&
(h=b.path+h),g=k.image(h,0,0,l,l)):(g=this.createMarker(c,d,e,void 0,void 0,void 0,void 0,g))&&g.translate(l/2,l/2);this.addListeners(g,a);k=k.set([g]);this.switchable&&k.setAttr("cursor","pointer");(f=this.switchType)&&"none"!=f&&("x"==f?(t=this.createX(),t.translate(l/2,l/2)):t=this.createV(),t.dItem=a,!0!==a.hidden?"x"==f?t.hide():t.show():"x"!=f&&t.hide(),this.switchable||t.hide(),this.addListeners(t,a),a.legendSwitch=t,k.push(t));f=this.color;a.showBalloon&&this.textClickEnabled&&void 0!==this.selectedColor&&
(f=this.selectedColor);this.useMarkerColorForLabels&&(f=d);!0===a.hidden&&(f=this.markerDisabledColor);d=AmCharts.massReplace(this.labelText,{"[[title]]":a.title});t=this.fontSize;g&&l<=t&&g.translate(n,l/2+this.ly-t/2+(t+2-l)/2-p);var q;d&&(d=AmCharts.fixBrakes(d),a.legendTextReal=d,q=AmCharts.text(this.container,d,f,b.fontFamily,t,"start"),q.translate(this.lx+m,this.ly),k.push(q),b=q.getBBox().width,this.maxLabelWidth<b&&(this.maxLabelWidth=b));this.entries[this.index]=k;a.legendEntry=this.entries[this.index];
...
a.hidden||this.dispatch("clickLabel",a):this.switchable&&(!0===a.hidden?this.dispatch("showItem",a):this.dispatch("hideItem",a))},dispatch:function(a,b){this.fire(a,{type:a,dataItem:b,target:this,chart:this.chart})},createValue:function(a){var b=this,c=b.fontSize;if(!1!==a.visibleInLegend){var d=b.maxLabelWidth;b.equalWidths||(b.valueAlign="left");"left"==b.valueAlign&&(d=a.legendEntry.getBBox().width);var e=d;if(b.valueText&&0<b.valueWidth){var f=b.color;b.useMarkerColorForValues&&(f=a.color,a.legendKeyColor&&
(f=a.legendKeyColor()));!0===a.hidden&&(f=b.markerDisabledColor);var g=b.valueText,d=d+b.lx+b.markerLabelGap+b.valueWidth,h="end";"left"==b.valueAlign&&(d-=b.valueWidth,h="start");f=AmCharts.text(b.container,g,f,b.chart.fontFamily,c,h);f.translate(d,b.ly);b.entries[b.index].push(f);e+=b.valueWidth+2*b.markerLabelGap;f.dItem=a;b.valueLabels.push(f)}b.index++;f=b.markerSize;f<c+7&&(f=c+7,AmCharts.VML&&(f+=3));c=b.container.rect(b.markerSize,0,e,f,0,0).attr({stroke:"none",fill:"#ffffff","fill-opacity":.005});
c.dItem=a;b.entries[b.index-1].push(c);c.mouseover(function(){b.rollOverLabel(a)}).mouseout(function(){b.rollOutLabel(a)}).click(function(){b.clickLabel(a)})}},createV:function(){var a=this.markerSize;return AmCharts.polygon(this.container,[a/5,a/2,a-a/5,a/2],[a/3,a-a/5,a/5,a/1.7],this.switchColor)},createX:function(){var a=(this.markerSize-4)/2,b={stroke:this.switchColor,"stroke-width":3},c=this.container,d=AmCharts.line(c,[-a,a],[-a,a]).attr(b),a=AmCharts.line(c,[-a,a],[a,-a]).attr(b);return this.container.set([d,
...
p);b=b.replace(/@XXXX@/g,AmCharts.monthNames[d]);b=b.replace(/@XXX@/g,AmCharts.shortMonthNames[d]);b=b.replace(/@XX@/g,n);b=b.replace(/@X@/g,d+1);b=b.replace(/@RR@/g,m);b=b.replace(/@R@/g,e);b=b.replace(/@PPPP@/g,AmCharts.dayNames[f]);b=b.replace(/@PPP@/g,AmCharts.shortDayNames[f]);b=b.replace(/@PP@/g,t);return b=b.replace(/@P@/g,f)};
...
b.scrollbarOnly=!0;b.zoomOutText="";b.panEventsEnabled=this.panelsSettings.panEventsEnabled;b.marginLeft=c.marginLeft;b.marginRight=c.marginRight;b.marginTop=0;b.marginBottom=0;var c=d.dateFormats,e=b.categoryAxis;e.boldPeriodBeginning=d.boldPeriodBeginning;c&&(e.dateFormats=d.dateFormats);e.labelsEnabled=!1;e.parseDates=!0;d=a.graph;if(AmCharts.isString(d)){c=this.panels;for(e=0;e<c.length;e++){var h=AmCharts.getObjById(c[e].stockGraphs,a.graph);h&&(d=h)}a.graph=d}var f;d&&(f=new AmCharts.AmGraph(this.theme),
f.valueField=d.valueField,f.periodValue=d.periodValue,f.type=d.type,f.connect=d.connect,f.minDistance=a.minDistance,b.addGraph(f));d=new AmCharts.ChartScrollbar(this.theme);b.addChartScrollbar(d);AmCharts.copyProperties(a,d);d.scrollbarHeight=a.height;d.graph=f;this.listenTo(d,"zoomed",this.handleScrollbarZoom);f=document.createElement("div");f.style.height=a.height+"px";d=this.periodSelectorContainer;c=this.periodSelector;e=this.centerContainer;"bottom"==a.position?c?"bottom"==c.position?e.insertBefore(f,
d):e.appendChild(f):e.appendChild(f):c?"top"==c.position?e.insertBefore(f,d.nextSibling):e.insertBefore(f,e.firstChild):e.insertBefore(f,e.firstChild);b.write(f)}},handleScrollbarZoom:function(a){if(this.skipScrollbarEvent)this.skipScrollbarEvent=!1;else{var b=a.endDate,c={};c.startDate=a.startDate;c.endDate=b;this.updateScrollbar=!1;this.handleZoom(c)}},addPeriodSelector:function(){var a=this.periodSelector;if(a){var b=this.categoryAxesSettings.minPeriod;a.minDuration=AmCharts.getPeriodDuration(b);
a.minPeriod=b;a.chart=this;var c=this.dataSetSelector,d,b=this.dssContainer;c&&(d=c.position);var c=this.panelsSettings.panelSpacing,e=document.createElement("div");this.periodSelectorContainer=e;var h=this.leftContainer,f=this.rightContainer,g=this.centerContainer,k=this.panelsContainer,l=a.width+2*c+"px";switch(a.position){case "left":h.style.width=a.width+"px";h.appendChild(e);g.style.paddingLeft=l;break;case "right":g.style.marginRight=l;f.appendChild(e);f.style.width=a.width+"px";break;case "top":k.style.clear=
"both";g.insertBefore(e,k);e.style.paddingBottom=c+"px";e.style.overflow="hidden";break;case "bottom":e.style.marginTop=c+"px","bottom"==d?g.insertBefore(e,b):g.appendChild(e)}this.listenTo(a,"changed",this.handlePeriodSelectorZoom);a.write(e)}},addDataSetSelector:function(){var a=this.dataSetSelector;if(a){a.chart=this;a.dataProvider=this.dataSets;var b=a.position,c=this.panelsSettings.panelSpacing,d=document.createElement("div");this.dssContainer=d;var e=this.leftContainer,h=this.rightContainer,
f=this.centerContainer,g=this.panelsContainer,c=a.width+2*c+"px";switch(b){case "left":e.style.width=a.width+"px";e.appendChild(d);f.style.paddingLeft=c;break;case "right":f.style.marginRight=c;h.appendChild(d);h.style.width=a.width+"px";break;case "top":g.style.clear="both";f.insertBefore(d,g);d.style.overflow="hidden";break;case "bottom":f.appendChild(d)}a.write(d)}},handlePeriodSelectorZoom:function(a){var b=this.scrollbarChart;b&&(b.updateScrollbar=!0);a.predefinedPeriod?(this.predefinedStart=
...
this.chartCursors,b;for(b=0;b<a.length;b++){var c=a[b];c.hideCursor(!1);(c=c.chart)&&c.updateLegendValues()}},handleCursorZoom:function(a){var b=this.scrollbarChart;b&&(b.updateScrollbar=!0);var b={},c;if(this.categoryAxesSettings.equalSpacing){var d=this.mainDataSet.categoryField,e=this.mainDataSet.agregatedDataProviders[this.currentPeriod];c=new Date(e[a.start][d]);a=new Date(e[a.end][d])}else c=new Date(a.start),a=new Date(a.end);b.startDate=c;b.endDate=a;this.handleZoom(b)},handleZoom:function(a){this.zoomChart(a.startDate,
a.endDate)},zoomChart:function(a,b){var c=new Date(a),d=this,e=d.firstDate,h=d.lastDate,f=d.currentPeriod,g=d.categoryAxesSettings,k=g.minPeriod,l=d.panelsSettings,p=d.periodSelector,w=d.panels,t=d.comparedGraphs,y=d.scrollbarChart,x=d.firstDayOfWeek;if(e&&h){a||(a=e);b||(b=h);if(f){var n=AmCharts.extractPeriod(f);a.getTime()==b.getTime()&&n!=k&&(b=AmCharts.changeDate(b,n.period,n.count),b.setTime(b.getTime()-1))}a.getTime()<e.getTime()&&(a=e);a.getTime()>h.getTime()&&(a=h);b.getTime()<e.getTime()&&
(b=e);b.getTime()>h.getTime()&&(b=h);n=AmCharts.getItemIndex(k,g.groupToPeriods);g=f;f=d.choosePeriod(n,a,b);d.currentPeriod=f;var n=AmCharts.extractPeriod(f),v=AmCharts.getPeriodDuration(n.period,n.count);AmCharts.getPeriodDuration(k);1>b.getTime()-a.getTime()&&(a=new Date(b.getTime()-1));k=AmCharts.newDate(a);d.extendToFullPeriod&&(k.getTime()-e.getTime()<.1*v&&(k=AmCharts.resetDateToMin(a,n.period,n.count,x)),h.getTime()-b.getTime()<.1*v&&(b=AmCharts.resetDateToMin(h,n.period,n.count,x),b=AmCharts.changeDate(b,
n.period,n.count,!0)));for(e=0;e<w.length;e++)h=w[e],h.chartCursor&&h.chartCursor.panning&&(k=c);for(e=0;e<w.length;e++){h=w[e];if(f!=g){for(c=0;c<t.length;c++)v=t[c].graph,v.dataProvider=v.dataSet.agregatedDataProviders[f];c=h.categoryAxis;c.firstDayOfWeek=x;c.minPeriod=f;h.dataProvider=d.mainDataSet.agregatedDataProviders[f];if(c=h.chartCursor)c.categoryBalloonDateFormat=d.chartCursorSettings.categoryBalloonDateFormat(n.period),h.showCategoryAxis||(c.categoryBalloonEnabled=!1);h.startTime=k.getTime();
h.endTime=b.getTime();h.validateData(!0)}c=!1;h.chartCursor&&h.chartCursor.panning&&(c=!0);c||(h.startTime=void 0,h.endTime=void 0,h.zoomToDates(k,b));0<l.startDuration&&d.animationPlayed&&!c?(h.startDuration=0,h.animateAgain()):0<l.startDuration&&!c&&h.animateAgain()}d.animationPlayed=!0;AmCharts.extractPeriod(f);l=new Date(b);y&&d.updateScrollbar&&(y.zoomToDates(a,l),d.skipScrollbarEvent=!0,setTimeout(function(){d.resetSkip.call(d)},100));d.updateScrollbar=!0;d.startDate=a;d.endDate=b;p&&p.zoom(a,
b);if(a.getTime()!=d.previousStartDate.getTime()||b.getTime()!=d.previousEndDate.getTime())p={type:"zoomed"},p.startDate=a,p.endDate=b,p.chart=d,p.period=f,d.fire(p.type,p),d.previousStartDate=new Date(a),d.previousEndDate=new Date(b)}d.eventsHidden&&d.showHideEvents(!1);d.chartCreated||(f="init",d.fire(f,{type:f,chart:d}));d.chartRendered||(f="rendered",d.fire(f,{type:f,chart:d}),d.chartRendered=!0);f="drawn";d.fire(f,{type:f,chart:d});d.chartCreated=!0;d.animationPlayed=!0},resetSkip:function(){this.skipScrollbarEvent=
!1},updateGraphs:function(){this.getSelections();if(0<this.dataSets.length){var a=this.panels;this.comparedGraphs=[];var b;for(b=0;b<a.length;b++){var c=a[b],d=c.valueAxes,e;for(e=0;e<d.length;e++){var h=d[e];h.prevLog&&(h.logarithmic=h.prevLog);h.recalculateToPercents="always"==c.recalculateToPercents?!0:!1}d=this.mainDataSet;e=this.comparedDataSets;h=c.stockGraphs;c.graphs=[];var f;for(f=0;f<h.length;f++){var g=h[f],g=AmCharts.processObject(g,AmCharts.StockGraph,this.theme);h[f]=g;if(!g.title||
g.resetTitleOnDataSetChange)g.title=d.title,g.resetTitleOnDataSetChange=!0;g.useDataSetColors&&(g.lineColor=d.color,g.fillColors=void 0,g.bulletColor=void 0);c.addGraph(g);var k=!1;"always"==c.recalculateToPercents&&(k=!0);var l=c.stockLegend,p,w,t,y;l&&(l=AmCharts.processObject(l,AmCharts.StockLegend,this.theme),c.stockLegend=l,p=l.valueTextComparing,w=l.valueTextRegular,t=l.periodValueTextComparing,y=l.periodValueTextRegular);if(g.comparable){var x=e.length;0<x&&g.valueAxis.logarithmic&&"never"!=
c.recalculateToPercents&&(g.valueAxis.logarithmic=!1,g.valueAxis.prevLog=!0);0<x&&"whenComparing"==c.recalculateToPercents&&(g.valueAxis.recalculateToPercents=!0);l&&g.valueAxis&&!0===g.valueAxis.recalculateToPercents&&(k=!0);var n;for(n=0;n<x;n++){var v=e[n],q=g.comparedGraphs[v.id];q||(q=new AmCharts.AmGraph(this.theme),q.id="comparedGraph"+n+"_"+f+v.id);q.periodValue=g.periodValue;q.dataSet=v;q.behindColumns=g.behindColumns;g.comparedGraphs[v.id]=q;q.seriesIdField="amCategoryIdField";q.connect=
g.connect;var m=g.compareField;m||(m=g.valueField);var D=!1,A=v.fieldMappings,z;for(z=0;z<A.length;z++)A[z].toField==m&&(D=!0);if(D){q.valueField=m;q.title=v.title;q.lineColor=v.color;g.compareGraphType&&(q.type=g.compareGraphType);m=g.compareGraphLineThickness;isNaN(m)||(q.lineThickness=m);m=g.compareGraphDashLength;isNaN(m)||(q.dashLength=m);m=g.compareGraphLineAlpha;isNaN(m)||(q.lineAlpha=m);m=g.compareGraphCornerRadiusTop;isNaN(m)||(q.cornerRadiusTop=m);m=g.compareGraphCornerRadiusBottom;isNaN(m)||
(q.cornerRadiusBottom=m);m=g.compareGraphBalloonColor;isNaN(m)||(q.balloonColor=m);if(m=g.compareGraphFillColors)q.fillColors=m;if(m=g.compareGraphNegativeFillColors)q.negativeFillColors=m;if(m=g.compareGraphFillAlphas)q.fillAlphas=m;if(m=g.compareGraphNegativeFillAlphas)q.negativeFillAlphas=m;if(m=g.compareGraphBullet)q.bullet=m;if(m=g.compareGraphNumberFormatter)q.numberFormatter=m;m=g.compareGraphPrecision;isNaN(m)||(q.precision=m);if(m=g.compareGraphBalloonText)q.balloonText=m;m=g.compareGraphBulletSize;
isNaN(m)||(q.bulletSize=m);m=g.compareGraphBulletAlpha;isNaN(m)||(q.bulletAlpha=m);m=g.compareGraphBulletBorderAlpha;isNaN(m)||(q.bulletBorderAlpha=m);if(m=g.compareGraphBulletBorderColor)q.bulletBorderColor=m;m=g.compareGraphBulletBorderThickness;isNaN(m)||(q.bulletBorderThickness=m);q.visibleInLegend=g.compareGraphVisibleInLegend;q.balloonFunction=g.compareGraphBalloonFunction;q.hideBulletsCount=g.hideBulletsCount;q.valueAxis=g.valueAxis;l&&(k&&p?(q.legendValueText=p,q.legendPeriodValueText=t):
(w&&(q.legendValueText=w),y&&(q.legendPeriodValueText=y)));c.showComparedOnTop?c.graphs.push(q):c.graphs.unshift(q);this.comparedGraphs.push({graph:q,dataSet:v})}}}l&&(k&&p?(g.legendValueText=p,g.legendPeriodValueText=t):(w&&(g.legendValueText=w),y&&(g.legendPeriodValueText=y)))}}}},choosePeriod:function(a,b,c){var d=this.categoryAxesSettings,e=d.groupToPeriods,h=e[a],e=e[a+1],f=AmCharts.extractPeriod(h),f=AmCharts.getPeriodDuration(f.period,f.count),g=b.getTime(),k=c.getTime(),d=d.maxSeries;return(k-
g)/f>d&&0<d&&e?this.choosePeriod(a+1,b,c):h},handleCursorChange:function(a){var b=a.target,c=a.position,d=a.zooming;a=a.index;var e=this.chartCursors,h;for(h=0;h<e.length;h++){var f=e[h];f!=b&&c&&(f.isZooming(d),f.previousMousePosition=NaN,f.forceShow=!0,f.setPosition(c,!1,a))}},getSelections:function(){var a=[],b=this.dataSets,c;for(c=0;c<b.length;c++){var d=b[c];d.compared&&a.push(d)}this.comparedDataSets=a;b=this.panels;for(c=0;c<b.length;c++)d=b[c],"never"!=d.recalculateToPercents&&0<a.length?
d.hideDrawingIcons(!0):d.drawingIconsEnabled&&d.hideDrawingIcons(!1)},addPanel:function(a){this.panels.push(a);AmCharts.removeChart(a);AmCharts.addChart(a)},addPanelAt:function(a,b){this.panels.splice(b,0,a);AmCharts.removeChart(a);AmCharts.addChart(a)},removePanel:function(a){var b=this.panels,c;for(c=b.length-1;0<=c;c--)if(b[c]==a){var d={type:"panelRemoved",panel:a,chart:this};this.fire(d.type,d);b.splice(c,1);a.destroy();a.clear()}},validateData:function(){this.resetDataParsed();this.updateDataSets();
this.mainDataSet.compared=!1;this.updateGraphs();this.updateData();var a=this.dataSetSelector;a&&a.write(a.div)},resetDataParsed:function(){var a=this.dataSets,b;for(b=0;b<a.length;b++)a[b].dataParsed=!1},validateNow:function(){this.skipDefault=!0;this.chartRendered=!1;this.clear(!0);this.write(this.div)},hideStockEvents:function(){this.showHideEvents(!1);this.eventsHidden=!0},showStockEvents:function(){this.showHideEvents(!0);this.eventsHidden=!1},showHideEvents:function(a){var b=this.panels,c;for(c=
0;c<b.length;c++){var d=b[c].graphs,e;for(e=0;e<d.length;e++){var h=d[e];!0===a?h.showBullets():h.hideBullets()}}},invalidateSize:function(){var a=this;clearTimeout(a.validateTO);var b=setTimeout(function(){a.validateNow()},5);a.validateTO=b},measure:function(){var a=this.div,b=a.offsetWidth,c=a.offsetHeight;a.clientHeight&&(b=a.clientWidth,c=a.clientHeight);this.divRealWidth=b;this.divRealHeight=c},clear:function(a){var b=this.panels,c;if(b)for(c=0;c<b.length;c++){var d=b[c];a||(d.cleanChart(),d.destroy());
...
k;if(d)g=b.width-6+"px",AmCharts.addBr(f);else{var g=b.inputFieldWidth+"px",l=document.createTextNode(" ");f.appendChild(l)}k.style.width=g;k=document.createTextNode(AmCharts.lang.toText||b.toText);f.appendChild(k);d&&AmCharts.addBr(f);k=document.createElement("input");k.className="amChartsInputField";c&&AmCharts.applyStyles(k.style,c.PeriodInputField);k.style.textAlign="center";k.onblur=function(){b.handleCalChange()};AmCharts.isNN&&k.addEventListener("keypress",function(a){b.handleCalendarChange.call(b,
a)},!0);AmCharts.isIE&&k.attachEvent("onkeypress",function(a){b.handleCalendarChange.call(b,a)});f.appendChild(k);b.endDateField=k;d?AmCharts.addBr(f):e=k.offsetHeight+2;g&&(k.style.width=g)}f=b.periods;if(AmCharts.ifArray(f)){g=document.createElement("div");d||(g.style.cssFloat="right",g.style.styleFloat="right",g.style.display="inline");a.appendChild(g);d&&AmCharts.addBr(g);a=document.createTextNode(AmCharts.lang.periodsText||b.periodsText);g.appendChild(a);b.periodContainer=g;var p;for(a=0;a<f.length;a++)k=
f[a],p=document.createElement("input"),p.type="button",p.value=k.label,p.period=k.period,p.count=k.count,p.periodObj=k,p.className="amChartsButton",c&&AmCharts.applyStyles(p.style,c.PeriodButton),d&&(p.style.width=b.width-1+"px"),p.style.boxSizing="border-box",g.appendChild(p),b.addEventListeners(p),k.button=p;!d&&p&&(h=p.offsetHeight);b.offsetHeight=Math.max(e,h)}},addEventListeners:function(a){var b=this;AmCharts.isNN&&a.addEventListener("click",function(a){b.handlePeriodChange.call(b,a)},!0);AmCharts.isIE&&
...
{type:"changed"};e.startDate=c;e.endDate=b;e.chart=this.chart;e.event=a;this.fire(e.type,e)}},handlePeriodChange:function(a){this.selectPeriodButton((a.srcElement?a.srcElement:a.target).periodObj,!1,a)},setRanges:function(a,b){this.firstDate=a;this.lastDate=b;this.getPeriodDates()},selectPeriodButton:function(a,b,c){var d=a.button,e=d.count,h=d.period,f,g,k=this.firstDate,l=this.lastDate,p,w=this.theme;k&&l&&("MAX"==h?(f=k,g=l):"YTD"==h?(f=new Date,f.setMonth(0,1),f.setHours(0,0,0,0),0===e&&f.setDate(f.getDate()-
1),g=this.lastDate):"YYYY"==h||"MM"==h?this.selectFromStart?(f=k,g=new Date(k),g.setMonth(g.getMonth()+e)):(f=new Date(l),AmCharts.changeDate(f,h,e,!1),f.setDate(f.getDate()-1),g=l):(p=AmCharts.getPeriodDuration(h,e),this.selectFromStart?(f=k,g=new Date(k.getTime()+p-1)):(f=new Date(l.getTime()-p+1),g=l)),a.startTime=f.getTime(),this.hideOutOfScopePeriods&&(b&&a.startTime<k.getTime()?d.style.display="none":d.style.display="inline"),f.getTime()>l.getTime()&&(p=AmCharts.getPeriodDuration("DD",1),f=
new Date(l.getTime()-p)),f.getTime()<k.getTime()&&(f=k),"YTD"==h&&(a.startTime=f.getTime()),a.endTime=g.getTime(),b||(this.skipMark=!0,this.unselectButtons(),d.className="amChartsButtonSelected",w&&AmCharts.applyStyles(d.style,w.PeriodButtonSelected),a={type:"changed"},a.startDate=f,a.endDate=g,a.predefinedPeriod=h,a.chart=this.chart,a.count=e,a.event=c,this.fire(a.type,a)))},markButtonAsSelected:function(){if(!this.skipMark){var a=this.chart,b=this.periods,c=a.startDate.getTime(),a=a.endDate.getTime(),
...
AmCharts.parseStockData=function(a,b,c,d,e){(new Date).getTime();var h={},f=a.dataProvider,g=a.categoryField;if(g){var k=AmCharts.getItemIndex(b,c),l=c.length,p,w=f.length,t,y={};for(p=k;p<l;p++)t=c[p],h[t]=[];var x={},n=a.fieldMappings,v=n.length;for(p=0;p<w;p++){var q=f[p],m=q[g],m=m instanceof Date?AmCharts.newDate(m,b):e?AmCharts.stringToDate(m,e):new Date(m),D=m.getTime(),A={};for(t=0;t<v;t++)A[n[t].toField]=q[n[t].fromField];var z;for(z=k;z<l;z++){t=c[z];var s=AmCharts.extractPeriod(t),B=s.period,
E=s.count,u,r;if(z==k||D>=y[t]||!y[t]){x[t]={};x[t].amCategoryIdField=String(AmCharts.resetDateToMin(m,B,E,d).getTime());var C;for(C=0;C<v;C++)s=n[C].toField,u=x[t],r=Number(A[s]),u[s+"Count"]=0,u[s+"Sum"]=0,isNaN(r)||(u[s+"Open"]=r,u[s+"Sum"]=r,u[s+"High"]=r,u[s+"Low"]=r,u[s+"Close"]=r,u[s+"Count"]=1,u[s+"Average"]=r);u.dataContext=q;h[t].push(x[t]);z>k&&(s=AmCharts.newDate(m,b),s=AmCharts.changeDate(s,B,E,!0),s=AmCharts.resetDateToMin(s,B,E,d),y[t]=s.getTime());if(z==k)for(var F in q)q.hasOwnProperty(F)&&
(x[t][F]=q[F]);x[t][g]=AmCharts.newDate(m,b)}else for(B=0;B<v;B++)s=n[B].toField,u=x[t],p==w-1&&(u[g]=AmCharts.newDate(m,b)),r=Number(A[s]),isNaN(r)||(isNaN(u[s+"Low"])&&(u[s+"Low"]=r),r<u[s+"Low"]&&(u[s+"Low"]=r),isNaN(u[s+"High"])&&(u[s+"High"]=r),r>u[s+"High"]&&(u[s+"High"]=r),u[s+"Close"]=r,E=AmCharts.getDecimals(u[s+"Sum"]),C=AmCharts.getDecimals(r),u[s+"Sum"]+=r,u[s+"Sum"]=AmCharts.roundTo(u[s+"Sum"],Math.max(E,C)),u[s+"Count"]++,u[s+"Average"]=u[s+"Sum"]/u[s+"Count"])}}}a.agregatedDataProviders=
h};
AmCharts.parseEvents=function(a,b,c,d,e,h){var f=a.stockEvents,g=a.agregatedDataProviders,k=b.length,l,p,w,t,y,x,n,v;for(l=0;l<k;l++){x=b[l];y=x.graphs;w=y.length;var q;for(p=0;p<w;p++)t=y[p],t.customBulletField="amCustomBullet"+t.id+"_"+x.id,t.bulletConfigField="amCustomBulletConfig"+t.id+"_"+x.id;for(var m=0;m<f.length;m++)if(n=f[m],q=n.graph,AmCharts.isString(q)&&(q=AmCharts.getObjById(y,q)))n.graph=q}for(var D in g)if(g.hasOwnProperty(D)){q=g[D];var A=AmCharts.extractPeriod(D),z=q.length,s;for(s=
0;s<z;s++){var B=q[s];l=B[a.categoryField];v=l instanceof Date;h&&!v&&(l=AmCharts.stringToDate(l,h));var E=l.getTime();y=A.period;var m=A.count,u;u="fff"==y?l.getTime()+1:AmCharts.resetDateToMin(AmCharts.changeDate(new Date(l),A.period,A.count),y,m,d).getTime();for(l=0;l<k;l++)for(x=b[l],y=x.graphs,w=y.length,p=0;p<w;p++){t=y[p];var r={};r.eventDispatcher=e;r.eventObjects=[];r.letters=[];r.descriptions=[];r.shapes=[];r.backgroundColors=[];r.backgroundAlphas=[];r.borderColors=[];r.borderAlphas=[];
r.colors=[];r.rollOverColors=[];r.showOnAxis=[];for(m=0;m<f.length;m++){n=f[m];v=n.date instanceof Date;h&&!v&&(n.date=AmCharts.stringToDate(n.date,h));v=n.date.getTime();var C=!1;n.graph&&(n.graph.showEventsOnComparedGraphs&&n.graph.comparedGraphs[a.id]&&(C=!0),(t==n.graph||C)&&v>=E&&v<u&&(r.eventObjects.push(n),r.letters.push(n.text),r.descriptions.push(n.description),n.type?r.shapes.push(n.type):r.shapes.push(c.type),void 0!==n.backgroundColor?r.backgroundColors.push(n.backgroundColor):r.backgroundColors.push(c.backgroundColor),
...
this,c,d=b.theme;a.className="amChartsDataSetSelector";var e=b.width;c=b.position;b.width=void 0;b.position=void 0;AmCharts.applyStyles(a.style,b);b.div=a;b.width=e;b.position=c;a.innerHTML="";var e=b.position,h;h="top"==e||"bottom"==e?!1:!0;b.vertical=h;var f;h&&(f=b.width+"px");var e=b.dataProvider,g,k;if(1<b.countDataSets("showInSelect")){c=document.createTextNode(AmCharts.lang.selectText||b.selectText);a.appendChild(c);h&&AmCharts.addBr(a);var l=document.createElement("select");f&&(l.style.width=
f);b.selectCB=l;d&&AmCharts.applyStyles(l.style,d.DataSetSelect);a.appendChild(l);AmCharts.isNN&&l.addEventListener("change",function(a){b.handleDataSetChange.call(b,a)},!0);AmCharts.isIE&&l.attachEvent("onchange",function(a){b.handleDataSetChange.call(b,a)});for(c=0;c<e.length;c++)if(g=e[c],!0===g.showInSelect){k=document.createElement("option");k.text=g.title;k.value=c;g==b.chart.mainDataSet&&(k.selected=!0);try{l.add(k,null)}catch(p){l.add(k)}}b.offsetHeight=l.offsetHeight}if(0<b.countDataSets("showInCompare")&&
...
(e=1);var f=0,g=0,k=0,l,k=this.fontSize,p=this.mastHeight,w=this.shape,t=this.textColor;void 0!==this.color&&(t=this.color);void 0===a&&(a="");a=AmCharts.text(d,a,t,this.chart.fontFamily,this.fontSize);d=a.getBBox();this.labelWidth=t=d.width;this.labelHeight=d.height;d=0;switch(w){case "sign":l=this.drawSign(b);f=p+4+k/2;d=p+k+4;1==e&&(f-=4);break;case "flag":l=this.drawFlag(b);g=t/2+3;f=p+4+k/2;d=p+k+4;1==e&&(f-=4);break;case "pin":l=this.drawPin(b);f=6+k/2;d=k+8;break;case "triangleUp":l=this.drawTriangleUp(b);
f=-k-1;d=k+4;e=-1;break;case "triangleDown":l=this.drawTriangleDown(b);f=k+1;d=k+4;e=-1;break;case "triangleLeft":l=this.drawTriangleLeft(b);g=k;d=k+4;e=-1;break;case "triangleRight":l=this.drawTriangleRight(b);g=-k;e=-1;d=k+4;break;case "arrowUp":l=this.drawArrowUp(b);a.hide();break;case "arrowDown":l=this.drawArrowDown(b);a.hide();d=k+4;break;case "text":e=-1;l=this.drawTextBackground(b,a);f=this.labelHeight+3;d=k+10;break;case "round":l=this.drawCircle(b)}this.bullets[c]=l;this.showOnAxis?(l=isNaN(this.nextAxisY)?
this.axisCoordinate:this.nextY,k=f*e,this.nextAxisY=l+e*d):(l=this.nextY,k=f*e);a.translate(g,k);b.push(a);b.translate(0,l);this.addEventListeners(b,c);this.nextY=l+e*d;this.stackDown=h},addEventListeners:function(a,b){var c=this;a.click(function(){c.handleClick(b)}).mouseover(function(){c.handleMouseOver(b)}).touchend(function(){c.handleMouseOver(b,!0)}).mouseout(function(){c.handleMouseOut(b)})},drawPin:function(a){var b=-1;this.stackDown&&(b=1);var c=this.fontSize+4;return this.drawRealPolygon(a,
...
/***************************************************************************************************
    ...
    Inclusions CodeKit des dependances "AmCharts" specifiques aux roles "Manager" et "Secretaire"

*/


//@codekit-prepend "static/amcharts/amcharts.js";
//@codekit-prepend "static/amcharts/amstock.js";
//@codekit-prepend "static/amcharts/serial.js";
