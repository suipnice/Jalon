...
idobj = context.invokeFactory(type_name='JalonCours', id="Cours-%s-%s" % (REQUEST["member_id"], DateTime().strftime("%Y%m%d%H%M%S")))
...
obj.creerSousObjet("Forum", "Discussion générale", "Discutez ici librement du cours.", REQUEST["member_id"], "", "")
